 ...
 *
 */
/* this version edited for SVR4.2 */
/* Further SVR4.2 mods by Greg Lehey, LEMIS, 16 May 1993 */
...
/* the Makefile generates the SVR4 define*/
...
/* #define HPUX */                /* No need, predefined */
/* #define AIXV3 */
/* #define SGI */
...
#if defined (__GNUC__) && defined (__STDC__)		    /* gcc defines this as 1, SVR4 espects 0 */
/* the idea of this line is to avoid warnings. However, in gcc at any rate, it just changes the
 * flavour of the warning ("undefining __STDC__") */
#undef __STDC__						    /* no warnings, please */
#define __STDC__ 0
#endif
 ...
 * (56700 and 115200 bps). This option is currently available to

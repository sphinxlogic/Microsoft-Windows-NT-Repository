#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_getimage.c,v 1.16 93/01/28 14:45:52 sam Exp $";
#endif
...
DECLAREContigPutFunc(putRGBcontig8bitCMYKtile)
{
	...
	if (Map) {
		while (h-- > 0) {
			...
			for (x = w; x-- > 0;) {
				k = pp[3];
				r = 255 - MIN(pp[0]+k/3, 255);
				g = 255 - MIN(pp[1]+k/3, 255);
				b = 255 - MIN(pp[2]+k/3, 255);

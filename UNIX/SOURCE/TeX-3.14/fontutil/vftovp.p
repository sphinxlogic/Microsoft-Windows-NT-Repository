...
type{5:}byte=0..255;{:5}{22:}index=0..tfmsize;{:22}var{7:}
vffile:packed file of byte;vfname:packed array[1..FILENAMESIZE]of char;
{:7}{10:}tfmfile:packed file of byte;
tfmname:packed array[1..FILENAMESIZE]of char;{:10}{12:}
lf,lh,bc,ec,nw,nh,nd,ni,nl,nk,ne,np:0..32767;{:12}{20:}vplfile:text;
vplname:packed array[1..FILENAMESIZE]of char;{:20}{23:}
...
curname:packed array[1..FILENAMESIZE]of char;b0,b1,b2,b3:byte;
...
vflimit:0..vfsize;o:byte;{:123}procedure initialize;var k:integer;
begin setpaths(TFMFILEPATHBIT+VFFILEPATHBIT);{11:}
if argc<>4 then begin writeln('Usage: <vfm file> <tfm file> <vpl file>.'
);uexit(1);end;argv(1,vfname);
...
uexit(1);end;writeln('This is VFtoVP, C Version 1.2');{:11}{21:}
...
writeln('pt'){:36};{39:}fontchars[fontptr]:=vfptr;{44:}
for k:=1 to FILENAMESIZE do curname[k]:=' ';r:=0;
for k:=fontstart[fontptr]+14 to vfptr-1 do begin r:=r+1;
if r+4>FILENAMESIZE then begin writeln('Font name too long for me!');
writeln('Sorry, but I can''t go on; are you sure this is a VF?');

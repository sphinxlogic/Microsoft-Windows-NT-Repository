...
gfname,pkname:packed array[1..FILENAMESIZE]of char;gfloc,curloc:integer;
...
slashpos:=-1;last:=1;
while(pkname[last]<>' ')and(last<=FILENAMESIZE-5)do begin if pkname[last
]='.'then dotpos:=last;if pkname[last]='/'then slashpos:=last;

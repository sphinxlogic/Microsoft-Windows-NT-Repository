...
hashsize=5003;{:3}type{23:}byte=0..255;ASCIIcode=32..127;{:23}{66:}
fourbytes=record b0:byte;b1:byte;b2:byte;b3:byte;end;{:66}{71:}
fixword=integer;{:71}{78:}headerindex=0..maxheaderbytes;indx=0..32767;
{:78}{81:}pointer=0..1032;{:81}var{5:}vplfile:text;{:5}{21:}
vffile:packed file of 0..255;tfmfile:packed file of 0..255;
vfname,tfmname,vplname:packed array[1..FILENAMESIZE]of char;{:21}{24:}
...
d:headerindex;{:79}{83:}c:byte;{:83}begin{6:}
if argc<4 then begin writeln(
'Usage: vptovf <vpl file> <vfm file> <tfm file>.');uexit(1);end;
argv(1,vplname);reset(vplfile,vplname);
writeln('This is VPtoVF, C Version 1.3');{:6}{22:}argv(2,vfname);
rewrite(vffile,vfname);argv(3,tfmname);rewrite(tfmfile,tfmname);{:22}

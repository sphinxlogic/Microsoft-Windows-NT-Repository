...
{/* 41 42 31 32 */ storefmtfile_regmem 
  ...
  packjobname ( 779 ) ; 
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1264 , 779 ) ; 
  printnl ( 1265 ) ; 
...
{initprim_regmem 
  ...
  primitive ( 273 , 100 , 1 ) ; 
  primitive ( 274 , 100 , 2 ) ; 
  primitive ( 1218 , 100 , 3 ) ; 
  primitive ( 1219 , 60 , 1 ) ; 
  primitive ( 1220 , 60 , 0 ) ; 
  primitive ( 1221 , 58 , 0 ) ; 
  primitive ( 1222 , 58 , 1 ) ; 
  primitive ( 1228 , 57 , 11639 ) ; 
  primitive ( 1229 , 57 , 11895 ) ; 
  primitive ( 1230 , 19 , 0 ) ; 
  primitive ( 1231 , 19 , 1 ) ; 
  primitive ( 1232 , 19 , 2 ) ; 
  primitive ( 1233 , 19 , 3 ) ; 
...
{texbody_regmem 
  ...
  if ( ( 0 > 0 ) || ( 32767 < 127 ) ) 
  bad = 11 ; 
  if ( ( 0 > 0 ) || ( 1073741823L < 32767 ) ) 
  bad = 12 ; 
  if ( ( 0 < 0 ) || ( 32767 > 1073741823L ) ) 
  bad = 13 ; 
  if ( ( memmin < 0 ) || ( memmax >= 1073741823L ) || ( -0 - memmin > 
  1073741824L ) ) 
  bad = 14 ; 
  if ( ( 0 < 0 ) || ( fontmax > 32767 ) ) 
  bad = 15 ; 
  if ( fontmax > 256 ) 
  bad = 16 ; 
  ...
  termoffset = 0 ; 
  fileoffset = 0 ; 
  (void) Fputs( stdout ,  "This is TeX, C Version 3.14t3" ) ; 
  if ( formatident > 0 ) 
  print ( formatident ) ; 
  println () ; 
  flush ( stdout ) ; 

...
#define	EDITOR	"/opt/bin/emacs +%d %s"
...
#define	TEXFONTS	".:/opt/lib/tex/fonts"
#define	TEXFORMATS	".:/opt/lib/tex/formats"
#define	TEXINPUTS	".:/opt/lib/tex/inputs"
#define	TEXPOOL		"/opt/lib/tex/formats"
#define	MFBASES		".:/opt/lib/mf/bases"
#define	MFINPUTS	".:/opt/lib/mf/inputs"
#define	MFPOOL		"/opt/lib/mf/bases"
#define	VFFONTS		".:/opt/lib/tex/fonts/vf"
...
#define	TEXFONTS_SUBDIR  "/opt/lib/tex/fonts"
#define	TEXINPUTS_SUBDIR "/opt/lib/tex/inputs"
#define	MFINPUTS_SUBDIR  "/opt/lib/mf/inputs"
#endif

/* BibTeX search path for .bib files.  BibTeX uses TEXINPUTS to search
   for .bst files.  */ 
#define	BIBINPUTS	".:/opt/lib/tex/bibtex"

...
/* Definitions for SVR4.2 - the current version of this program seems
 * to assume that all UNIX is 4.2BSD. This creates trouble in exactly
 * one place in dviterm.h, so... */

#define SVR4_2						    /* this is our Destiny (Greg Lehey, 14 April 1993) */
...
#define FONTLIST	"GF-PK-PXL"	/* preferred search order */
#endif /* FONTLIST */

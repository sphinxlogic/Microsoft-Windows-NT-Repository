...
maxwidths=10000;linelength=79;terminallinelength=150;stacksize=100;
...
curname:packed array[1..FILENAMESIZE]of char;{:24}{25:}
b0,b1,b2,b3:eightbits;{:25}{30:}fontnum:array[0..maxfonts]of integer;
...
c,q,d,m:integer;r:0..FILENAMESIZE;j,k:0..namesize;mismatch:boolean;
...
if r+4>FILENAMESIZE then begin writeln(stderr,
'DVItype capacity exceeded (max font name length=',FILENAMESIZE:1,')!');

...
maxparamwords=30;maxligsteps=5000;maxkerns=10000;hashsize=15077;{:3}
...
tfmname,plname:packed array[1..FILENAMESIZE]of char;{:15}{18:}
...
extralocneeded:boolean;{:138}{151:}verbose:boolean;{:151}
...
end;until getoptreturnval=-1;end{:148};
if verbose then writeln('This is PLtoTF, C Version 3.4');{6:}
argv(optind,plname);reset(plfile,plname);{:6}{16:}

...
changing:boolean;{:71}{73:}changebuffer:array[0..bufsize]of ASCIIcode;
changelimit:0..bufsize;{:73}{93:}curmodule:namepointer;
scanninghex:boolean;{:93}{108:}nextcontrol:eightbits;{:108}{114:}
lhs,rhs:namepointer;{:114}{118:}curxref:xrefnumber;{:118}{121:}
outbuf:array[0..linelength]of ASCIIcode;outptr:0..linelength;
outline:integer;{:121}{129:}dig:array[0..4]of 0..9;{:129}{144:}
...
label 20;
begin 20:if changing then changedmodule[modulecount]:=true else{83:}
begin line:=line+1;
...
checkchange;end{:83};if changing then begin{84:}begin line:=line+1;
if not inputln(changefile)then begin begin if not phaseone then begin
...
line:=templine;end;end;end{:84};
if not changing then begin changedmodule[modulecount]:=true;goto 20;end;
end;loc:=0;buffer[limit]:=32;end;{:82}{87:}
...
var k:0..bufsize;
begin if outptr>0 then flushbuffer(outptr,false)else begin for k:=0 to
limit do if(buffer[k]<>32)and(buffer[k]<>9)then goto 10;
flushbuffer(0,false);end;10:end;{:123}{127:}procedure breakout;label 10;
...
end{:128};d:=outbuf[k];if d=32 then begin flushbuffer(k,false);goto 10;
...
finishline;flushbuffer(0,false);while not inputhasended do{220:}
...
outbuf[outptr]:=105;end;finishline;flushbuffer(0,false);{:238};end{:220}
{:218};end;begin initialize;
writeln(stdout,'This is WEAVE, C Version 4.2');{64:}idloc:=10;

...
{schar oldsetting  ; 
  ...
  logopened = true ; 
  {
    (void) Fputs( logfile ,  "This is METAFONT, C Version 2.7" ) ; 
    print ( baseident ) ; 
    print ( 752 ) ; 
...
void printknownorunknowntype ( smallnumber t , integer v ) 
{printchar ( 40 ) ; 
  if ( t < 17 ) 
  if ( t != 14 ) 
  printtype ( t ) ; 
...
void depfinish ( halfword v , halfword q , smallnumber t ) 
{halfword p  ; 
  scaled vv  ; 
  if ( q == 0 ) 
  p = curexp ; 

...
{halfword lhs  ; 
  ...
  if ( curtype != 20 ) 
  {
    ...
    if ( internal [ 7 ] > 131072L ) 
    {
      ...
      print ( intname [ mem [ lhs ] .hhfield .lhfield - ( 2369 ) ] ) ; 
...
void settag ( halfword c , smallnumber t , halfword r ) 
{if ( chartag [ c ] == 0 ) 
  {
    chartag [ c ] = t ; 
    charremainder [ c ] = r ; 

...
void newboundary ( halfword p , smallnumber octant ) 
{halfword q, r  ; 
...
void finoffsetprep ( halfword p , halfword k , halfword w , integer x0 , 
integer x1 , integer x2 , integer y0 , integer y1 , integer y2 , boolean 
rising , integer n ) 
{/* 10 */ halfword ww  ; 
  scaled du, dv  ; 
  integer t0, t1, t2  ; 

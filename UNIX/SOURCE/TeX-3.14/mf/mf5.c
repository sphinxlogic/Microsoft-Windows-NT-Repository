...
void openawindow ( windownumber k , scaled r0 , scaled c0 , scaled r1 , scaled 
c1 , scaled x , scaled y ) 
{integer m, n  ; 
  if ( r0 < 0 ) 
  r0 = 0 ; 
...
halfword pplusq ( halfword p , halfword q , smallnumber t ) 
...
halfword ptimesv ( halfword p , integer v , smallnumber t0 , smallnumber t1 , 
boolean visscaled ) 
...
halfword pwithxbecomingq ( halfword p , halfword x , halfword q , smallnumber 
t ) 
{register halfword Result; halfword r, s  ; 
  integer v  ; 
  integer sx  ; 
...
void lineareq ( halfword p , smallnumber t ) 
{halfword q, r, s  ; 
  halfword x  ; 
  integer n  ; 
  integer v  ; 
...
halfword scantoks ( commandcode terminator , halfword substlist , halfword 
tailend , smallnumber suffixcount ) 

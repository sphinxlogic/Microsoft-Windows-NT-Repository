...
{primitive ( 408 , 40 , 1 ) ; 
  ...
  primitive ( 657 , 4 , 2370 ) ; 
  primitive ( 658 , 4 , 2520 ) ; 
  primitive ( 659 , 4 , 1 ) ; 
  primitive ( 454 , 4 , 0 ) ; 
  ...
  primitive ( 64 , 61 , 2 ) ; 
  primitive ( 662 , 61 , 3 ) ; 
  primitive ( 673 , 56 , 2370 ) ; 
  primitive ( 674 , 56 , 2520 ) ; 
  primitive ( 675 , 56 , 2670 ) ; 
  primitive ( 676 , 56 , 1 ) ; 
  primitive ( 677 , 56 , 2 ) ; 
  primitive ( 678 , 56 , 3 ) ; 
  primitive ( 688 , 3 , 0 ) ; 
...
{integer k  ; 
  ...
  hash [ 2359 ] .v.RH = 41 ; 
  hash [ 2357 ] .v.RH = 455 ; 
  eqtb [ 2359 ] .lhfield = 62 ; 
  mem [ 19 ] .hhfield .lhfield = 2370 ; 
  mem [ 19 ] .hhfield .v.RH = 0 ; 
  mem [ memtop ] .hhfield .lhfield = 65535L ; 
  ...
  mem [ 21 ] .hhfield .b1 = 0 ; 
  mem [ 21 ] .hhfield .v.RH = 2368 ; 
  eqtb [ 2368 ] .v.RH = 21 ; 
  eqtb [ 2368 ] .lhfield = 41 ; 
  eqtb [ 2358 ] .lhfield = 91 ; 
  hash [ 2358 ] .v.RH = 732 ; 
...
void main_body() {
  ...
  termoffset = 0 ; 
  fileoffset = 0 ; 
  (void) Fputs( stdout ,  "This is METAFONT, C Version 2.7" ) ; 
  if ( baseident > 0 ) 
  print ( baseident ) ; 
  println () ; 
  flush ( stdout ) ; 

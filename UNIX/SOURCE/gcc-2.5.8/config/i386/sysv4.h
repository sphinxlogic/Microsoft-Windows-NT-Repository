...
/* Modified by Greg Lehey (grog@lemis.de), 13 December 1993, to include
 * the symbols that imake expects (SVR4 and SYSV386). There seems to be no
 * good way to define SVR4.2 except by adding another config file, which
 * I don't want to do yet. */
#define CPP_PREDEFINES \
  "-Di386 -Dunix -D__svr4__ -DSVR4 -DSYSV386 -Asystem(unix) -Asystem(svr4) -Acpu(i386) -Amachine(i386)"

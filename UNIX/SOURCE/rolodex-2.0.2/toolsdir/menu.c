...
menu_match (
     ...
     ptr_rval,ptr_ur,prompt,casetest,isub,r_no_match,r_ambiguous,
#ifndef MSDOS
	n_options,va_alist
#else
 	n_options
...
#ifdef VMS
  int args_offset = 0;	/* args_offset must be 0 in order for this to work */
#endif
  va_list pvar;
...
int menu_data_help_or_abort (prompt,abortstring,ptr_response)

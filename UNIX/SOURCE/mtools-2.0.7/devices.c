...
struct device devices[] = {
	{'A', "/dev/rdsk/f03ht", 0L, 12, 0, (int (*) ()) 0, 80, 2, 18},
	{'A', "/dev/rdsk/f03dt", 0L, 12, 0, (int (*) ()) 0, 80, 2, 9},
	{'B', "/dev/rdsk/f1d9dt", 0L, 12, 0, (int (*) ()) 0, 40, 2, 9},
	{'B', "/dev/rdsk/f1q15dt", 0L, 12, 0, (int (*) ()) 0, 80, 2, 15},
	{'B', "/dev/rdsk/f1d8dt", 0L, 12, 0, (int (*) ()) 0, 40, 2, 8},

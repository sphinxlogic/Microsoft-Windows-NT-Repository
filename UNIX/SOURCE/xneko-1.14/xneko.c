...
#define	BITMAP_WIDTH		64	/* １キャラクタの幅 (ピクセル) */
#define	BITMAP_HEIGHT		64	/* １キャラクタの高さ (ピクセル) */

#define	WINDOW_WIDTH		640	/* ウィンドウの幅 (ピクセル) */
#define	WINDOW_HEIGHT		512	/* ウィンドウの高さ (ピクセル) */
    ...
    Bool	iconicState;
{
    ...
    theSizeHints.flags = PPosition | PSize | USPosition | USSize;

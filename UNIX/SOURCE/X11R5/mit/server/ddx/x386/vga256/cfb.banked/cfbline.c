/* $XFree86: mit/server/ddx/x386/vga256/cfb.banked/cfbline.c,v 2.0 1993/08/18 06:48:35 dawes Exp $ */
/***********************************************************
...
#ifdef POLYSEGMENT
#ifdef SPEEDUP
speedupcfbSegmentSS (pDrawable, pGC, nseg, pSeg)
#else
...
#else
#ifdef SPEEDUP
speedupcfbLineSS (pDrawable, pGC, mode, npt, pptInit)
#else
...
#endif
{
    ...
    unsigned long *addrl, *addrb; /* address of destination pixmap */

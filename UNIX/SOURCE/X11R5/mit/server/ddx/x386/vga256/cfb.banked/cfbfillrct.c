/* $XFree86: mit/server/ddx/x386/vga256/cfb.banked/cfbfillrct.c,v 2.0 1993/08/18 06:48:30 dawes Exp $ */
/*
 * Fill rectangles.
 */
...
extern void cfbFillRectSolidAnd (), cfbFillRectSolidOr ();
extern void cfbFillRectSolidXor (), cfbFillRectSolidGeneral ();
    ...
    xRectangle	*prectInit;  	/* Pointer to first rectangle to fill */
{
	...
	case GXand:
	    BoxFill = (rrop_xor == 0) ? 
		cfbFillRectSolidAnd : cfbFillRectSolidGeneral;
	    break;
	case GXor:
	    BoxFill = (rrop_and == 0) ? 
		cfbFillRectSolidOr : cfbFillRectSolidGeneral;
	    break;
	default:

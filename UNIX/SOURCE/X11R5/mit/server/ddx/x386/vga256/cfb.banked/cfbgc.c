/* $XFree86: mit/server/ddx/x386/vga256/cfb.banked/cfbgc.c,v 2.0 1993/08/18 06:48:33 dawes Exp $ */
/***********************************************************
    ...
    DrawablePtr	    pDrawable;
{
	...
	case LineSolid:
		...
		if (pGC->fillStyle == FillSolid)
		{
		    pGC->ops->Polylines = cfbLowlevFuncs.lineSS;
		    pGC->ops->PolySegment = cfbLowlevFuncs.segmentSS;
		}
 		else
    ...
    if (new_text && (pGC->font))
    {
	    ...
	    {
#if PPW == 4
                pGC->ops->ImageGlyphBlt = cfbLowlevFuncs.teGlyphBlt8;
#else

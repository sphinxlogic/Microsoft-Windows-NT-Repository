...
******************************************************************/
/* $XFree86: mit/server/ddx/x386/bdm2/mfb.banked/mfbbitblt.c,v 2.0 1993/08/30 15:23:00 dawes Exp $ */
...
extern int  (*ourbdm_mfbDoBitbltCopy)();
extern int  mfbDoBitbltXor();
extern int  (*ourbdm_mfbDoBitbltCopyInverted)();
    ...
    DDXPointPtr	    pptSrc;
{
    ...
    {
    case GXcopy:
	return ourbdm_mfbDoBitbltCopy (pSrc, pDst, alu, prgnDst, pptSrc);
    case GXxor:
	return mfbDoBitbltXor (pSrc, pDst, alu, prgnDst, pptSrc);
    case GXcopyInverted:
	return ourbdm_mfbDoBitbltCopyInverted (pSrc, pDst, alu, prgnDst, pptSrc);
    case GXor:
...
int dstx, dsty;
{
    ...
    switch (pGC->alu) {
    case GXcopy:
	localDoBitBlt = ourbdm_mfbDoBitbltCopy;
	break;
    case GXcopyInverted:
	localDoBitBlt = ourbdm_mfbDoBitbltCopyInverted;
	break;
    case GXxor:

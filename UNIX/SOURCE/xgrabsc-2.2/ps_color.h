 ...
 * Version:	1.4
 *
 * ccsid:	@(#)ps_color.h	1.4 - 7/9/92 12:48:57
 * from: 	ccs/s.ps_color.h
 * date: 	8/12/92 14:15:39
 *
 * description:  a program to print a color image
 *               on an old printer that does not
 *               support color PostScript
 *
 *               This file comes to xgrabsc via the excellent utility
 *               xwd2ps.  The comments have been moved from the postscript
 *               strings to C comments in the interest of saving space in
 *               the user's files.
 */
...
---------*/
  "",
  "systemdict /colorimage known userdict /colorimage known or not {",
  "  %% create if not in systemdict",
/*--------------

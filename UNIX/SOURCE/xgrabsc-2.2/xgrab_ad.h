...
"XGrab*.encap.fromHoriz:	landscape",
"XGrab*.encap.horizDistance:    10",
"XGrab*.encap.vertDistance:     55",
"XGrab*.encap.width: 90",
"XGrab*.encap.label: Encapsulated",
"XGrab*.onlyEpsi.fromHoriz: encap",
"XGrab*.onlyEpsi.horizDistance:  10",
"XGrab*.onlyEpsi.vertDistance:   55",
"XGrab*.onlyEpsi.label: Preview",
"XGrab*.epsi.fromHoriz: onlyEpsi",
"XGrab*.epsi.horizDistance:    10",
"XGrab*.epsi.vertDistance:     55",
"XGrab*.epsi.label: Encaps.+Preview",
...
"XGrab*.halftone.horizDistance:   67",
"XGrab*.halftone.vertDistance:   115",
"XGrab*.halftone.label: Halftone",
"XGrab*.mapbw.horizDistance:   135",
"XGrab*.mapbw.vertDistance:    115",
...
"XGrab*.fileText*string: screen.dmp",
...
"XGrab*.printerText*string: lpr -l",
"XGrab*.box6.horizDistance:   0",
"XGrab*.box6.vertDistance:  522",
"XGrab*.splat.label: -----------------------------------------------------",

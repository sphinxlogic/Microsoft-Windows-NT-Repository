/* $Header: /localsrc/news/usr/src/news/trn-2.0/nntp/acttimes.c,v 1.2 92/01/11 16:13:30 usenet Exp $
**
** $Log:	acttimes.c,v $
 * Revision 1.2  92/01/11  16:13:30  usenet
 * header diddling to match rn 4.4
 * 
*/

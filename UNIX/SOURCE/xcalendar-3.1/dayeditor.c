 ...
 *	$Header: /p/p4/X11R5/contrib/purdue/xcalendar/RCS/dayeditor.c,v 1.5 1993/04/01 14:59:01 bingle Exp $
 *      $Author: bingle $
 *      $Locker:  $
 *
...
#ifndef lint
static char *rcsid_dayeditor_c = "$Header: /p/p4/X11R5/contrib/purdue/xcalendar/RCS/dayeditor.c,v 1.5 1993/04/01 14:59:01 bingle Exp $";
#endif /* lint */
...

{
  ...
  XtSetValues(XawTextGetSource(editor->editor), args, 1);
       ...
       XtPointer call_data;
{
  ...
  if(editor == NULL){
#ifdef XI18N
     editor = CreateDayEditor("dayEditor",XawtextEdit, XawtextWrapLine, NULL);
#else
...
void SaveButtonHandler(w,data,call_data)
     Widget w;
     XtPointer data;
     XtPointer call_data;
{
     ...
     XtPointer call_data;
{
...
#ifdef XI18N
   {
      ...
      XtGetValues(editor->editor, arglist, 1);
...
#ifdef XI18N
   XtSetArg(args[4],XtNuseStringInPlace, False);
#else

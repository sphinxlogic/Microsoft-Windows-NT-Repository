...
XCalendar*helpFile:	%%XCALENDAR_LIBDIR%%/xcalendar.hlp

XCalendar*firstDay:		7

!bitmaps
XCalendar*prev*bitmap: %%XCALENDAR_LIBDIR%%/larrow.xbm
XCalendar*succ*bitmap: %%XCALENDAR_LIBDIR%%/rarrow.xbm
XCalendar*prevday*bitmap: %%XCALENDAR_LIBDIR%%/larrow.xbm
XCalendar*succday*bitmap: %%XCALENDAR_LIBDIR%%/rarrow.xbm
XCalendar*helpButton*bitmap: %%XCALENDAR_LIBDIR%%/qmark.xbm
XCalendar*quitButton*bitmap: %%XCALENDAR_LIBDIR%%/quit.xbm
...
XCalendar*helpButton*Background: Black
XCalendar*helpButton*Foreground: White
XCalendar*quitButton*Background: Black
...
XCalendar*editorControls*Command.Background: Black
...
XCalendar*currentForeground: Blue

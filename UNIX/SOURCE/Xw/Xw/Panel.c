 ...
 * which doesn't make sense. Fix by modifying XwpanelClassRec below,
 * but be prepared to replace this if any actions are required
 * (Greg Lehey, LEMIS, 30 June 1993) */
...
/* Replace these with actionsList, XtNumber(actionsList), if
 * any actions need to be put in (Greg Lehey, LEMIS, 30 June 1993) */
    /* actions		  */	NULL,
    /* num_actions	  */	0,
    /* resources          */    resources,

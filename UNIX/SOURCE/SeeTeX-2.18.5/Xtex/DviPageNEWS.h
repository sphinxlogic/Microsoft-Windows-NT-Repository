...
#ifndef _DviPage_NEWS_h

#define _DviPage_NEWS_h


#ifdef __STDC__
extern void initNEWS();
extern void psfigBeginNEWS (DviPageWidget, char *, int);
extern void psfigEndNEWS (DviPageWidget, char *);
extern void psfigPlotfileNEWS (DviPageWidget, char *);
extern int checkNEWS();
#else
extern void psfigBeginNEWS ();
extern void psfigEndNEWS ();
extern void psfigPlotfileNEWS ();
extern int checkNEWS();
#endif

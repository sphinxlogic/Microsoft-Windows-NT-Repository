...
#ifndef _DviPage_DPS_h

#define _DviPage_DPS_h


extern void initDPS();
#ifdef __STDC__
extern void psfigBeginDPS (DviPageWidget, char *, int);
extern void psfigEndDPS (DviPageWidget, char *);
extern void psfigPlotfileDPS (DviPageWidget, char *);
extern int  checkDPS();
#else
extern void psfigBeginDPS ();
extern void psfigEndDPS ();
extern void psfigPlotfileDPS ();
extern int  checkDPS();
#endif

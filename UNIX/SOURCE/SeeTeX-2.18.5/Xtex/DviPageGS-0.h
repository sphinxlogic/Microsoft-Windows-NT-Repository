...
#ifndef _DviPageGS_0_h

#define _DviPageGS_0_h

#ifdef __STDC__
extern void StartInterpreter (DviPageWidget);
extern void StopInterpreter (DviPageWidget);
extern void WriteBytes (DviPageWidget, char *);
extern void waitCopyAndAcknowledge (DviPageWidget, Bool, int, int, int,
	int, int, int);
#else
extern void StartInterpreter ();
extern void StopInterpreter ();
extern void WriteBytes ();
extern void waitCopyAndAcknowledge ();
#endif

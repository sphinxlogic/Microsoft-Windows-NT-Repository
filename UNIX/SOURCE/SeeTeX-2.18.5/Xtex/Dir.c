...
#ifdef __svr4__
/* at least some SVR4 headers have a #define st_mtime in sys/stat.h which really
 * screws things up here (Greg Lehey, LEMIS, 16 May 1993) */
#undef st_mtime
	dir->st_mtime = statBuf.st_mtim.st__sec;
#else

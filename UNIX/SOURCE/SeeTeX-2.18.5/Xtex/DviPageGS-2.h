...
#ifndef _DviPage_GS_2_h

#define _DviPage_GS_2_h

#include "DviPageGS-0.h"

#ifdef __STDC__
extern void psfigBeginGHOST (DviPageWidget, char *, int);
extern void psfigEndGHOST (DviPageWidget, char *);
extern void psfigPlotfileGHOST (DviPageWidget, char *);
#else
extern void psfigBeginGHOST ();
extern void psfigEndGHOST ();
extern void psfigPlotfileGHOST ();
#endif

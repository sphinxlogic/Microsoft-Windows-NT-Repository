...
#ifndef _DateConverter_h
#define _DateConverter_h
...
extern Date convert_string_to_date();
extern int is_valid_date();
extern char * default_month_names[];

#define XtRDate "Date"

#endif /* _DateConverter_h */

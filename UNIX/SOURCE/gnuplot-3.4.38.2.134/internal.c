#ifndef lint
static char *RCSid = "$Id: internal.c%v 3.38.2.81 1993/02/24 02:29:34 woo Exp woo $";
#endif
 ...
 * Don't!
 *
 * Why not use the system header files? (Greg Lehey, LEMIS, 13 September 1993)
 */
#ifndef __svr4__
#ifndef _CRAY
...
#else /* apollo */
#if defined(AMIGA_SC_6_1)||defined(ATARI)&&defined(__GNUC__)
int matherr(x)	/* AMIGA_SC_6_1 */
struct exception *x;

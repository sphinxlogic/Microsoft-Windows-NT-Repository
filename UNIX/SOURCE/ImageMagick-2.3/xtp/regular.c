...
*/
static char
  *NextToken _Declare((register char *)),
  *Node _Declare((int)),
  *Piece _Declare((int *)),
  *Regular _Declare((int,int *));

static int
  Repeat _Declare((char *));

static void
  EmitCode _Declare((int)),
  Tail _Declare((char *,char *));

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                             %
  ...
  *regular_expression;
{
  ...
  */
  ...
  /*
    Allocate space.
  */
  r=(RegularExpression *) malloc((code_size+sizeof(RegularExpression)));

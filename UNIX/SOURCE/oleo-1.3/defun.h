...
"or it can be given a name with [store_last_macro] and then invoked",
...
"defining others, use [store-last-kbd-macro].",
#endif
...
#endif
#ifdef DOC_STRINGS
"Execute STRING as a keyboard macro PREFIX times.",
#endif
...
"Lines may be continuted by precediing the final newline with an",
...
#endif
#ifdef DOC_STRINGS
"Equivelent to: {exit-minibuffer}{auto-move}{edit-cell}",
...
#endif
#ifdef DOC_STRINGS
"Equivelent to: {exit-minibuffer}{auto-next-set}{edit-cell}",
"This command is used to terminate an edit-cell command, move to another",
...
"This command only applies when an argument is being editted.",
"",
...
"This command can only be executed when a cell formula is being editted.",
...
#endif
#ifdef DOC_STRINGS
"Map the last-typed character in the keysequence argument being editted.",

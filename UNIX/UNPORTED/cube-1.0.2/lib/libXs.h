...
extern Widget    xss_create_label_button ();
extern Widget    xs_create_pixmap_browser ();
extern Widget    xss_create_pixmap_button ();
extern Widget    xss_create_pixmap_browser ();
extern Widget    xss_create_label_wbutton ();
extern Pixel     xss_get_pixel_by_name ();

...
#define F_LSH_V(sr,n,ds) \
	ds.h = (((n) >= 32)? (sr.l << ((n) - 32)): \
		(sr.h << (n)) | ((sr.l >> (32 - (n))) & ((1u << (n)) - 1))) \
		& 0xFFFFFFFF; \
	ds.l = ((n) >= 32)? 0: (sr.l << (n)) & 0xFFFFFFFF
#define F_RSH_V(sr,n,ds) \
	ds.l = (((n) >= 32)? (sr.h >> ((n) - 32)) & ((1u << (64 - (n))) - 1): \
		((sr.l >> (n)) & ((1u << (32 - (n))) - 1)) | \
		(sr.h << (32 - (n)))) & 0xFFFFFFFF; \
	ds.h = ((n) >= 32)? 0: \
		((sr.h >> (n)) & ((1u << (32 - (n))) - 1)) & 0xFFFFFFFF
...
#define F_LSH_K(sr,n,ds) \
	ds.h = 	((sr.h << (n)) | ((sr.l >> (32 - (n))) & ((1u << (n)) - 1))) \
		& 0xFFFFFFFF; \
	ds.l = (sr.l << (n)) & 0xFFFFFFFF
#define F_RSH_K(sr,n,ds) \
	ds.l = 	(((sr.l >> (n)) & ((1u << (32 - (n))) - 1)) | \
		(sr.h << (32 - (n)))) & 0xFFFFFFFF; \
	ds.h = 	((sr.h >> (n)) & ((1u << (32 - (n))) - 1)) & 0xFFFFFFFF

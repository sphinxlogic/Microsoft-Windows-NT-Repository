...
%
%      InitializeCube(number_pixels,depth)
%
%  A description of each parameter follows.
%
...
%
*/
static void InitializeCube(number_pixels,depth)
unsigned int
  number_pixels;
...
%
*/
void MapImage(image,map_image,dither)
Image
  *image,
  *map_image;
  ...
  dither;
{
  ...
  */
  InitializeCube((unsigned int) (~0),8);
  ...
  colorspace;
{
  ...
  InitializeCube(image->columns*image->rows,depth);
...
%
*/
void QuantizeImages(images,number_images,number_colors,tree_depth,dither,
  colorspace)
Image
  **images;
  ...
  colorspace;
{
  ...
  InitializeCube((unsigned int) (~0),depth);

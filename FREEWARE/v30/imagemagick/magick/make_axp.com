...
$call Make colors
$call Make signature
$call Make decode ("HasJPEG","HasTIFF","HasXPM")
$call Make encode ("HasJPEG","HasTIFF","HasXPM")
$call Make compress
$call Make utility
$call Make error
...
$        if (p2.eqs."")
$          then
$            cc/standard=VAXC/nodebug/optimize/ -
               include_directory=([-],[-.jpeg],[-.tiff],[-.xpm]) 'source_file'
$          else
$            cc/standard=VAXC/nodebug/optimize/ -
               include_directory=([-],[-.jpeg],[-.tiff],[-.xpm]) /define='p2' -
               'source_file'  
$          endif
$      endif
$exit

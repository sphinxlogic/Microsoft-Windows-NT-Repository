...
MISC	=	readme., install., todo, sox.man, st.man, \
		descrip_decc.mms, sox_decc.opt, vms.lis, sound2au.com, sound2sun_decc.opt

SOUNDLIB  =	soundtools.olb_decc

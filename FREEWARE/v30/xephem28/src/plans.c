...
static void aux_jsun P_((double t, double *x1, double *x2, double *x3,
    double *x4, double *x5, double *x6));
static void masun P_((double mjd, double *mas));
static void p_mercury P_((double map[], double *dl, double *dr));
static void p_venus P_((double t, double mas, double map[], double *dl,
    double *dr, double *dml, double *dm));
static void p_mars P_((double mas, double map[], double *dl, double *dr,
    double *dml, double *dm));
static void p_jupiter P_((double t, double s, double *dml, double *ds,
    double *dm, double *da));
static void p_saturn P_((double t, double s, double *dml, double *ds,
    double *dm, double *da, double *dhl));
static void p_uranus P_((double t, double s, double *dl, double *dr,
    double *dml, double *ds, double *dm, double *da, double *dhl));
static void p_neptune P_((double t, double s, double *dl, double *dr,
    double *dml, double *ds, double *dm, double *da, double *dhl));

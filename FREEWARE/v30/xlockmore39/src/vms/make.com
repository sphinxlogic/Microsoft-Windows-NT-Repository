...
$if axp
$ then
$   cc=="CC/STANDAR=VAXC/INCLUDE=[]/DEFINE=(''defs')"
$   else
$   cc=="CC/INCLUDE=[]/DEFINE=(''defs')"
$endif
$if p1.eqs."DEBUG" .or. p2.eqs."DEBUG" .or. p3.eqs."DEBUG"
$ then
$ if axp
$ then
$   cc=="CC/DEB/NOOPT/STANDAR=VAXC/INCLUDE=[]/DEFINE=(''defs')/list"
$   else
$     cc=="CC/DEB/NOOPT/INCLUDE=[]/define=''defs'"
$  endif
$   link=="LINK/DEB"
$ endif
$!

...
#if defined(UCX) || defined(MULTINET) || defined(NETLIB)
#define HAVE_SOCKETS
...
/WARNING=(DISABLE=(ADDRCONSTEXT,GLOBALEXT,LONGEXTERN)) \
...
#define internal_with_output_to_temp_buffer	internal_with_out_to_temp_buf
#define do_line_insertion_deletion_costs	do_line_insert_delete_costs
#define x_start_queuing_selection_requests	x_start_queuing_select_requests
#define x_stop_queuing_selection_requests	x_stop_queuing_select_requests
#define insert_before_markers_and_inherit	insert_before_marks_and_inherit
#define insert_from_string_before_markers	insert_from_string_before_marks
#define Fprevious_single_property_change	Fprev_single_property_change
#define Sprevious_single_property_change	Sprev_single_property_change

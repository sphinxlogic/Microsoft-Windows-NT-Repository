...
When called interactively, prompt for the name of the color to use."
  ...
  (modify-frame-parameters (selected-frame)
			   (list (cons 'bar-background-color color-name))))
...
When called interactively, prompt for the name of the color to use."
  ...
  (modify-frame-parameters (selected-frame)
			   (list (cons 'bar-foreground-color color-name))))

(defun set-bar-background-color (color-name)
...
(defun set-bar-foreground-color (color-name)
...
(defun set-bar-shadow-width (width)
  "Set the width of the scrollbar shadow of the selected frame to WIDTH.
When called interactively, prompt for the name of the color to use."
  (interactive "NWidth: ")
  (modify-frame-parameters (selected-frame)
			   (list (cons 'bar-shadow-width width))))

(defun set-bar-top-shadow-color (color-name)
  "Set the top color of the scrollbar shadow of the selected frame to COLOR.
When called interactively, prompt for the name of the color to use."
  (interactive "sColor: ")
  (modify-frame-parameters (selected-frame)
			   (list (cons 'bar-top-shadow-color color-name))))

(defun set-bar-bottom-shadow-color (color-name)
  "Set the bottom color of the scrollbar shadow of the selected frame to COLOR.
When called interactively, prompt for the name of the color to use."
  (interactive "sColor: ")
  (modify-frame-parameters (selected-frame)
			   (list (cons 'bar-bottom-shadow-color color-name))))

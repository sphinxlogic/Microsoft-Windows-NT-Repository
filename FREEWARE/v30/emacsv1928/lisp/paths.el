...
(defvar Info-default-directory-list
  (let ((start (if (memq system-type '(vax-vms axp-vms))
		   nil
...
(defvar news-path (if (memq system-type '(vax-vms axp-vms))
		      ""
		    "/usr/spool/news/")
...
(defvar gnus-nntp-service (if (memq system-type '(vax-vms axp-vms)) 119 "nntp")
...
(defconst term-file-prefix (if (memq system-type '(vax-vms axp-vms))
			       "[.term]"
			     "term/")

...
#include <bitmaps/crosswv.xbm>

#include <bitmaps/leftptr.xbm>
#include <bitmaps/leftpmsk.xbm>
#include <bitmaps/rtptr.xbm>
#include <bitmaps/rtpmsk.xbm>
#include <bitmaps/cntrptr.xbm>
#include <bitmaps/cntrpmsk.xbm>
#include <bitmaps/stipple.xbm>

#endif /* VMS */
#else /* ! EMACS_BITMAP_FILES */

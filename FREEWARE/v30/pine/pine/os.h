...
#define	fflush		___ttflush
#define	MoveCursor	_MoveCursor
...
#define SYSTEM_PINERC             "UTIL$:pine.conf"
...
/*----------------------------------------------------------------------
 ...
 ----*/
#define DF_DEFAULT_FCC            "mymail"
#define DEFAULT_SAVE              "mail"
#define POSTPONED_MAIL            "SYS$LOGIN:postponed-mail"
#define INTERRUPTED_MAIL          "SYS$LOGIN:interrupted-mail"
#define DF_MAIL_DIRECTORY         "SYS$LOGIN:"
...
#define	DF_DRIVER_PROTO		  (&vmsmailproto)
#define DF_STANDARD_PRINTER       "SYS$PRINT"
...
/*----------------------------------------------------------------------
   ...
   OS dependencies, generic version.  See also the os-xxx.c files.

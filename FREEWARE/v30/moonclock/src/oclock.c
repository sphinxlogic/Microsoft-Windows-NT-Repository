...
"       [-fg {color}] [-bg {color}] [-bd {color}] [-bw {pixels}]\n");
    fprintf(stderr,
"       [-minute {color}] [-hour {color}] [-jewel {color}] [-night {color}]\n");
    fprintf(stderr, 
"       [-moonclock] [-sky {color}] [-moon { color}] [-stars {color}]\n");    
    fprintf(stderr,
"       [-timezone {Zone Offset}] [-nightstart { Night Offset }]");
    fprintf(stderr,
...
{"-timezone",   "*clock.timezone",      XrmoptionSepArg,        NULL},
{"-nightstart", "*clock.nightstart",    XrmoptionSepArg,        NULL},
{"-night",	"*clock.night",		XrmoptionSepArg,	NULL},
{"-sky",        "*clock.sky",           XrmoptionSepArg,	NULL},
{"-moon",       "*clock.moon",          XrmoptionSepArg,	NULL},
{"-stars",      "*clock.stars",         XrmoptionSepArg,	NULL},
...
{"-moonclock",  "*clock.moonclock",     XrmoptionNoArg,		"TRUE"} 
};

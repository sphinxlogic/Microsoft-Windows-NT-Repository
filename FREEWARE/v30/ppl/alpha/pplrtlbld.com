...
$ ! 1-010 - Added EVAX specific items for EVAX/Alpha port	PJC  12-Nov-1991
$ !--
...
$ LINK/NOSYSLIB/NOTRACEBACK/SHARE=EXE$:PPLRTL/MAP=MAP$:PPLRTL/FULL-
    /NONATIVE_ONLY/CROSS COM$:PPLRTLLNK/OPTIONS, RESOBJ$:BASE_LEVEL/OPTIONS
$ !
...
$ If vax then CPYSYSLIB OBJ$:PPLVECTOR.OBJ
...
$ LINK/NOTRACEBACK/NOMAP/SHARE=EXE$:PPLMSG -
   LIB$:PPLMSGTXT/INCLUDE=PPL$MSGDEF,RESOBJ$:BASE_LEVEL/OPT
$ !
...
$ !
$ !
$ ! Delete the OLB that contains the AMACRO emulation routines.
$ !
$ IF EVAX
$ THEN
$   DELETE LIB$:AMAC$EMULATION_ROUTINES.OLB;*
$ ENDIF
$ !
$ !
$ GOTO EXIT
...
$QUAL:
$ !
$ !     Check the IIF file against the native shareable image.
$ !
$ @SYSBLDCOM$:Symvectst.Com 'Targdev'[SYSLIB]PPLRTL 'Targdev'[SYSLIB]PPLRTL.IIF
$ GOTO EXIT
$ !
$ ! Failure exit
$ !

...
#define DISTRIBUTION_MESSAGE_1 "   This is an unofficial OpenVMS AXP version compiled by:"
#define DISTRIBUTION_MESSAGE_2 "   Fred Kleinsorge, Digital Equipment Corporation"

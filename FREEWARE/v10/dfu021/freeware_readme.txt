DFU, SYSTEM MANAGEMENT, High Performace disk/file utility.
!
...
Available functions :
 ...
 - DIRECTORY functions : COMPRESS or DUMP directories
                       : search directories for files with 
                          multiple versions , alias file 
                          entries , empty or corrupted 
                          directories
                       : create directories with 
                          preallocated size
 - quick disk REPORTING for file, freespace and disk usage 
    statistics 

     ...
     Lisp_Object name, defalt;
{
  ...
  tlen += strlen (nm) + 10;	/* VMS might need that extra space in
...
#ifdef VMS /* On VMS, this needs to be done BEFORE utime, or we get a file
	      access conflict.  -- Richard Levitte */

  ...
  (unwind-protect
	...
	(save-excursion
	  (save-restriction
	    ...
	    ;; On VMS, get new messages from MAIL if a file wasn't specified and the
	    ;; rmail-inbox-list is not empty.
	    (if (and (eq system-type 'vax-vms)
		     (not file-name))
		     ;; rmail-inbox-list) [ WHY? -- Richard Levitte ]
		(call-process "vmsgetmail" nil t nil " --newmail" "--delete"))

...
$       single_tree="YES"
$       run_in_place="NO"
$!		  ## If SINGLE_TREE is specified, instead of looping
$!		  ## back to while, change opt to PREFIX and fall
$!		  ## through to path option handling.  This will
$!		  ## cause SINGLE_TREE to make the behavior specified
$!		  ## in the help message
$	opt = "PREFIX"
$      NOT_SINGLE_TREE:
...
$   else
$    if "''with_ucx'" .nes. "NO" .and. "''with_multinet'" .nes. "NO"
$     then

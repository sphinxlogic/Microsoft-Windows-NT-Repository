$! Build of XShuffle for OpenVMS VAX or OpenVMS AXP
$!
...
$ write sys$output ""
$ write sys$output "    [1mBuilding XShuffle for OpenVMS ''cpu' - Dual Architecture VMScluster Demo[0m"
$ write sys$output ""
$ if cpu .eqs. "AXP" then cc :== cc/standard=vaxc
$ define/nolog sys sys$library
$ write sys$output "Compiling XSHUFFLE.C..."
$ cc/obj=xshuffle_'cpu' xshuffle.c
$ write sys$output "Linking XSHUFFLE..."
$ write sys$output ""
$ link/exe=xshuffle_'cpu' -
        xshuffle_'cpu',-
        sys$input/option

/*----------------------------------------------------------------------
  $Id: os-sun.h,v 5.8 1993/11/16 00:32:46 hubert Exp $
...
/*----------------------------------------------------------------------
   ...
   OS dependencies, SunOS 4.1 version.  See also the os-sun.c files.
...
/* Sun doesn't have these two functions, provide them in os.c */
typedef long fpos_t;

 ...
 */
#ifndef DOMAIN_NAME
-- error - define your domain name below and delete this line --
#define DOMAIN_NAME ".your.domain.here"
#endif
...
/* organization name */
#ifndef ORG_NAME
-- error - define your organization name below and delete this line --
#define ORG_NAME	"Your Company/Organization"
#endif
...
#if defined(macII) || defined(aiws) || defined(hpux) || (defined(SYSV) && !defined(i386)) || defined(i386)
#define SYSV_REGEX
 ...
 */
#if defined(convex) || (defined(sony) && !defined(SVR4)) || (!defined(sun) && !defined(ultrix) && !defined(__osf__) && !defined(SYSV) && !defined(_XOPEN_SOURCE)) || defined(ibm032) || defined(sequent) || defined(_IBMR2)
#define NEED_TEMPNAM
#else

 ...
 **/
  ...
  */
     ...
     step = 1;
*3D
     if (Bnr.cube_height/12 > 1)
 	step = Bnr.cube_height/12;
*3E
*3I
...
*3D
 	XSync (XtDisplay(Bnr.cube_widget), FALSE);
*3E
*3I
...
*3E
 		    ...
 		    Bnr.background);
*3D
 	    XFillRectangle (XtDisplay(Bnr.cube_widget), XtWindow (Bnr.cube_widget),
*3E
*3I
...
*3D
     number_of_disks = Bnr.cube_height/12;
*3E
*3I
...
*3D
     disk_line_width = Bnr.cube_height/(number_of_disks*2);
*3E
*3I
...
*3D
     tower_bottom = Bnr.cube_height - 
 	(Bnr.cube_height - (3 * disk_thickness * number_of_disks + 
*3E
*3I
...
*3D
     tower_left[0] = (Bnr.cube_width - (2 * tower_shift + tower_base_size)) / 2;
*3E
*3I

...
*5D
     unsigned flg_pcntrl_in : 1;
     unsigned flg_pcntrl_out : 1;
*5E
*4D
     unsigned flg_waits : 1;
     unsigned flg_waiting : 1;
*4E
*4I
*5D
     unsigned flg_rsrc_recv : 1;
     unsigned flg_rsrc_send : 1;
*5E
*5I
...
*10D
     Display$_Line FreePgf;
     Display$_Line FreeSpf;
*10E
*10I
*12D
     Display$_Line SyfRate;
*12E
     Display$_Line PgIO;
     Display$_Line RemIO;
*10E

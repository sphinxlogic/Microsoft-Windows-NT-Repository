 ...
 * control-X commands.
 */
/* ctrl|'T' moved to the top for easy overloading by toggle_language */
KEYTAB  keytab[NBINDS] = {
	{CTRL|'T',		spell},
	{K_PAD_UP,		backline},
	{K_PAD_DOWN,		forwline},
	{K_PAD_RIGHT,		call_forwchar},
	{K_PAD_LEFT,		call_backchar},
	...
	{CTRL|'A',		gotobol},
	{CTRL|'B',		call_backchar},
	{CTRL|'C',		abort_composer},
	{CTRL|'D',		forwdel},
	{CTRL|'E',		gotoeol},
	{CTRL|'F',		call_forwchar},
	{CTRL|'G',		whelp},
	{CTRL|'H',		backdel},
	{CTRL|'I',		tab},
	{CTRL|'J',		fillpara},

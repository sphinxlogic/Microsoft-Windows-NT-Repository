/*----------------------------------------------------------------------
  $Id: os-hpp.h,v 5.10 1993/11/16 00:32:46 hubert Exp $
...
/*----------------------------------------------------------------------
   ...
   OS dependencies, HPUX 8.0 version.  See also the os-hpp.c files.
...
#ifdef TIOCGWINSZ /* older versions don't have it */

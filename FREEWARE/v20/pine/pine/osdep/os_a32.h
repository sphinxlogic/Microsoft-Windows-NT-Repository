/*----------------------------------------------------------------------
  $Id: os-a32.h,v 5.8 1993/11/16 00:32:46 hubert Exp $
...
/*----------------------------------------------------------------------
   ...
   OS dependencies, AIX 3.2 version.  See also the os-a32.c files.
...
#define const    /* compiler complains about const */
...
#include <termio.h>     /* this is needed for struct winsize */

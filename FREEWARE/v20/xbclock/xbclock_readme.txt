...
Because an Imakefile is obligate for a distribution, I've included
it. The Makefile is the one for Sun systems. On other systems to make
this clock you have to have a K&R-C-Compiler and you have to make a
Makefile first (unless you like to try "gcc -o xbclock xbclock.c -lX11"),
I recommend xmkmf in a proper made X distribution, so first type

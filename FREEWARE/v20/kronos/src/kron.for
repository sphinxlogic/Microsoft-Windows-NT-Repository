...
c
c --- Get current default directory for any added jobs
c
      call get_default (def_dir)
c
8     call clear
...
10    continue
100   return
915   format(' Space left in string heap = ',I4)
920   format(//,' ',a1,
...
1000  write(6,990)
      return
990   format(' Unable to open data base file.')
9000  format(' ',a)
      end
c
c---end add_job

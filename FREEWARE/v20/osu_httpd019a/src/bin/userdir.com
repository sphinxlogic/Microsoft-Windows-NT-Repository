...
$!    write net_link "HTTP/1.0 302 found", crlf
$!    write net_link "LocaTion: http://",host_name,port,"/~",search_arg,crlf,crlf
$    write net_link "content-type: text/html",crlf
$    write net_link "LocaTion: /~",search_arg,crlf,crlf
$    write net_link "<HTML><HEAD><TITLE>Found</TITLE></HEAD><BODY>",crlf
$    write net_link "Doc moved to <A HREF=""http://", host_name, port,"/~"
$    write net_link search_arg,""">/~",search_arg,"</A></BODY></HTML>,crlf
$    write net_link "</DNETCGI>"
$ endif
$ write_abort:
$    write net_link "</DNETCGI>"

...
$ IF "UCXTCP" .eqs. "BSDTCP" .and. (F$GETSYI("CPU") .GE. 128 .OR. 	F$TRNLNM("DECC$CC_DEFAULT") .EQS. "/DECC") THEN prefix_all = "/prefix=all"
$ CC /NOLIST/OBJECT=TSERVER_TCP.OBJ /DEFINE=UCXTCP tserver_tcp.c 'prefix_all'
...
$ @link_server.com UCXTCP /NOTRACEBACK/EXEC=HTTP_SERVER.EXE

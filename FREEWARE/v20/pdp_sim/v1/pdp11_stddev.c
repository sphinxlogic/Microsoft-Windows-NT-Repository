...
extern int int_req;
int ptr_csr = 0;					/* control/status */
int ptr_stopioe = 0;					/* stop on error */
int ptp_csr = 0;					/* control/status */
int ptp_stopioe = 0;					/* stop on error */
int tti_csr = 0;					/* control/status */
int tto_csr = 0;					/* control/status */
int clk_csr = 0;					/* control/status */

...
int rk_busy = 0;					/* controller busy */
int rk_stat = 0;					/* status register */
int rk_cmd = 0;						/* command register */
int rk_dar = 0;						/* disk address */
int rk_car = 0;						/* memory address */
int rk_swait = 10, rk_rwait = 10;			/* seek, rotate wait */

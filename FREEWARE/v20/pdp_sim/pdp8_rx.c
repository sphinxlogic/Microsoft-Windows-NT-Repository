...
int rx_tr = 0;						/* xfer ready flag */
int rx_err = 0;						/* error flag */
int rx_csr = 0;						/* control/status */
int rx_dbr = 0;						/* data buffer */
int rx_esr = 0;						/* error status */
int rx_ecode = 0;					/* error code */
int rx_track = 0;					/* desired track */
int rx_sector = 0;					/* desired sector */
int rx_state = IDLE;					/* controller state */
int rx_cwait = 100;					/* command time */
int rx_swait = 10;					/* seek, per track */
int rx_xwait = 1;					/* tr set time */
int rx_stopioe = 1;					/* stop on error */
unsigned char buf[RX_NUMBY] = { 0 };			/* sector buffer */

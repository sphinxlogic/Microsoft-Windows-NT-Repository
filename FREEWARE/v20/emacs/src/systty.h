...
#if 0
extern unsigned int waiting_for_ast;
#endif
extern unsigned int stop_input;
extern unsigned int input_ef;
extern unsigned int timer_ef;
extern unsigned int process_ef;
extern unsigned int input_eflist;
extern unsigned int timer_eflist;

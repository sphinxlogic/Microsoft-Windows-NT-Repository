...
#ifdef VMS
#if 0
/* Read any X window input available into kbd_buffer. */
vms_X_ast(input_ef)
     unsigned long input_ef;
{
  ...
  nread = XTread_socket (0, buf, 256, 0, 0);
  ...
  for (i = 0; i < nread; i++)
	...
	case ascii_keystroke:
	  fprintf (stderr, "ASTDEBUG: buf[%d] = ASCII keystroke with\n", i);
	  fprintf (stderr, "                 .code            = ");
	  Fprin1 (buf[i].code, Qexternal_debugging_output);
	  fprintf (stderr, "\n");
	  fprintf (stderr, "                 .frame_or_window = ");
	  Fprin1 (buf[i].frame_or_window, Qexternal_debugging_output);
	  fprintf (stderr, "\n");
	  fprintf (stderr, "                 .timestamp       = %d\n",
		   buf[i].timestamp);
	  break;
	case non_ascii_keystroke:
	  fprintf (stderr, "ASTDEBUG: buf[%d] = keystroke with\n", i);
	  fprintf (stderr, "                 .code            = ");
	  Fprin1 (buf[i].code, Qexternal_debugging_output);
	  fprintf (stderr, "\n");
	  ...
	  break;
	case mouse_click:
	  fprintf (stderr, "ASTDEBUG: buf[%d] = mouse click with\n", i);
	  fprintf (stderr, "                 .code            = ");
	  Fprin1 (buf[i].code, Qexternal_debugging_output);
	  fprintf (stderr, "\n");
	  fprintf (stderr, "                 .modifiers       = %d\n",

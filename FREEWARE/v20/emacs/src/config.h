...
/* On VMS, there exist several socket kits, which have some
   ...
   Supported right now are UCX and MultiNet. */
...
#define config_opsysfile "EMACS_LIBRARY:[000000.src.s]vms5-5.h" 
...
#define config_machfile "EMACS_LIBRARY:[000000.src.m]alpha.h"

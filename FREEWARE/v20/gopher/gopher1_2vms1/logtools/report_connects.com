$! report number of connections to Gopher server by address
$ reports_dir := gopher_root:[reports]	! CHANGE ME to path of report .COM & GAWK files
$ if P1 .eqs. "" then P1 = "gopher_root:[000000]_gopher.log"
...
$  T1 = T1 + ".TMP"
$  gawk -f'reports_dir'get_connects.gawk -- 'P1' > 'T1'
$  S1 = "sort_"+"''T1'"
$  sort 'T1' 'S1'
...
$  S2 = "sort_"+"''T2'"
$  sort/key=(position:1,size:60,descending) 'T2' 'S2'
$  DTM = f$cvtime( "", "ABSOLUTE", "DATETIME")
$  gawk -f'reports_dir'rpt_connects.gawk -v mfmt='MRF' -v dtm="''DTM'" -- 'S2' >'P2'
$!
$ endprog:
$  delete 'T1';*
$  delete 'S1';*

...
*/
#ifdef __DECC
#pragma module PARSE_OBJECTS "V1.4-2"
#else
#ifndef __GNUC__
#module PARSE_OBJECTS "V1.4-2"
#endif
#endif
#include "tpadef.h"
#include "mmk.h"
...
*/
    ...
    void Parse_Objects(char *, int, struct OBJECT *, int);
...
*/
    ...
    extern int po_state(), po_key();	    	    /* parse table info */
    ...
    extern int extract_prefix(char *, char *);	    /* module MISC */
    extern int extract_name(char *, char *);	    /* module MISC */
    ...
    extern unsigned int file_exists(char *, char *);	/* module FILEIO */
...
#ifdef __GNUC__
#define LIB$_SYNTAXERR ((int) lib$_syntaxerr)
...
**--
*/
void Parse_Objects(char *line, int linelen, struct OBJECT *objque, int is_target) {
...
*/
    	...
    	queue_insert(queued_object, tpa->tpa_l_objqptr->blink);
    	dep->target = obj;
/*
...
*/
    	    ...
    	    strcpy(filobj->name+i, realobjname);
    ...
    case PO_K_END_OBJ:
    	if (obj) {
    	    ...
    	    queue_insert(obj, tpa->tpa_l_objqptr->blink);
    	    obj = NULL;
    	}
    	break;

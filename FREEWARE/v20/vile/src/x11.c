 ...
 *
 * $Header: /usr2/foxharp/src/pgf/vile/RCS/x11.c,v 1.124 1995/10/19 20:02:25 pgf Exp $
 *
 */
...
static	void	x_paste_selection P(( void ));
static	Boolean	x_get_selected_text P((UCHAR **, SIZE_T *));
static	Boolean	x_convert_selection P((Widget, Atom *, Atom *, Atom *,
                                       XtPointer *, unsigned long *, int * ));
static	void	x_lose_selection P(( Widget, Atom * ));
...
static	void	x_get_selection P(( Widget, XtPointer, Atom *, Atom *,
                                    XtPointer, unsigned long *, int * ));
static	Boolean	too_light_or_too_dark P((Pixel));
static	Boolean	alloc_shadows P(( Pixel, Pixel *, Pixel * ));
...
#else
#if NO_WIDGETS
static	void	x_expose_scrollbar P(( Widget, XtPointer, XEvent *, Boolean * ));
static	void	draw_thumb P((Widget, int, int, int));
...
/*ARGSUSED*/
static void
x_expose_scrollbar(w, unused, ev, continue_to_dispatch)
    Widget	w;
    XtPointer	unused;
    XEvent     *ev;
...
static Boolean
alloc_shadows(pixel, light, dark)
    Pixel pixel;
    Pixel *light;
    Pixel *dark;
{
...
/* ARGSUSED */
static void
x_get_selection(w, cldat, selection, type, value, length, format)
    Widget         w;
    XtPointer      cldat;
    Atom          *selection;
    Atom          *type;
...
/* ARGSUSED */
static Boolean
x_convert_selection(w, selection, target, type, value, length, format)
    Widget	   w;
    Atom          *selection;
    Atom          *target;
    Atom          *type;

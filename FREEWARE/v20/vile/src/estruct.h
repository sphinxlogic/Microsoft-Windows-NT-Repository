...
/*
 * $Header: /usr2/foxharp/src/pgf/vile/RCS/estruct.h,v 1.269 1995/10/13 00:14:18 pgf Exp $
 */
 ...
 */
#if CC_TURBO || CC_WATCOM || CC_MSC || CC_DJGPP || CC_ZTC || SYS_WINNT || CC_CSETPP || CC_MSVC
...
#ifndef ANSI_PROTOS
#  if defined(__STDC__) || SYS_VMS || CC_NEWDOSCC
...
#  endif
   ...
   /* note: some systems (hpux, osf1) have K&R behavior with <stdarg.h> */
#ifndef ANSI_PROTOS
#  if HAVE_STDARG_H && ANSI_PROTOS
...
#if ANSI_PROTOS
# define CHGD_ARGS VALARGS *args, int level
# define CHGD_DECL
#else
# define CHGD_ARGS args, level
# define CHGD_DECL VALARGS *args; int level;
#endif

typedef	int	(*ChgdFunc) P(( CHGD_ARGS ));
...
# ifdef lint
#  undef  va_arg
#  define va_arg(ptr,cast) (cast)((char *)(ptr)-((char *)0))
# endif
#else
# if HAVE_VARARGS_H
#  include <varargs.h>

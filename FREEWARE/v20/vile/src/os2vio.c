 ...
 * stuff went in there.)
 *
 * $Header: /usr2/foxharp/src/pgf/vile/RCS/os2vio.c,v 1.4 1995/08/04 23:12:06 pgf Exp $
 */
...
static	void	vio_move   P((int,int));
static	void	vio_eeol   P((void));
static	void	vio_eeop   P((void));
static	void	vio_beep   P((void));
static	void    vio_open   P((void));
static	void	vio_rev    P((int));
static	int	vio_cres   P((char *));
static	void	vio_close  P((void));
static	void	vio_putc   P((int));

 ...
 *
 * $Header: /usr2/foxharp/src/pgf/vile/RCS/lckfiles.c,v 1.4 1995/03/25 02:53:53 pgf Exp $
 *
 */
...
static void get_lock_owner P(( char *, char *, int ));
static char *ourname P(( void ));

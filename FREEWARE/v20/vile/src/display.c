 ...
 *
 *
 * $Header: /usr2/foxharp/src/pgf/vile/RCS/display.c,v 1.202 1995/10/19 20:02:25 pgf Exp $
 *
 */
 ...
 */
#if ANSI_PROTOS
static char * right_num (char *buffer, int len, long value)
#else
static char *
 ...
 */
#if ANSI_PROTOS
static int dfputli(OutFunc outfunc, long l, int r)
#else
static
...
kill_tildes:
	 ...
	 */
	if (w_val(wp,WMDLINEWRAP)
	 && same_ptr(wp->w_line.l, wp->w_dot.l)) {

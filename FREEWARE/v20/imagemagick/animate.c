  ...
  terminate;
{
  ...
  (void) fprintf(stderr,
    "-borderwidth, -font, -foreground, -iconGeometry, -iconic, -name,\n");
  (void) fprintf(stderr,"-mattecolor, -shared_memory, or -title.\n");
  (void) fprintf(stderr,
    "\nChange '-' to '+' in any option above to reverse its effect.  For\n");
  (void) fprintf(stderr,
    "example, specify +compress to store the image as uncompressed.\n");
  ...
  number_scenes;
{
  ...
  */
  ...
  if (i > 0)
    (void) qsort((void *) images,number_scenes,sizeof(Image *),
              ...
              (images[scene]->colors > visual_info->colormap_size))
            {
              ...
              */
              ...
              QuantizeImage(images[scene],(unsigned int)
                ...
                resource_info->dither,resource_info->colorspace);
            }
        ...
        if (!identical_colormap)
          {
            ...
            */
            ...
            QuantizeImages(images,number_scenes,(unsigned int)
              visual_info->colormap_size,resource_info->tree_depth,
              resource_info->dither,resource_info->colorspace);
          }
      }
  ...
  if (resource_info->title != (char *) NULL)
  ...
  else
    {
      ...
      */
      ...
      while ((p > images[0]->filename) && (*(p-1) != *BasenameSeparator))
        p--;
  ...
  **argv;
{
  ...
  */
  ...
  resource_value=XGetResourceClass(resource_database,client_name,"delay","100");

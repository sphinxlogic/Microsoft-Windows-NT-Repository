...
*/
static void
  TransformMessageDigest _Declare((MessageDigest *,unsigned long *)),
  UpdateMessageDigest _Declare((MessageDigest *,unsigned char *,unsigned long));

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                             %
  ...
  *image;
{
  ...
  */
  ...
  if (colormap == (unsigned char *) NULL)
    {
      Warning("Unable to compute colormap signature",

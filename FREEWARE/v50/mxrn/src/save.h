...
/*
 * $Header: /net/objy27/wrld/mnt11/ricks/src/master/xrn/save.h,v 1.4 1993/01/11 02:15:25 ricks Exp $
 */
...
extern int saveRangeOfArticles _ARGUMENTS((char *, art_num, art_num));
extern int createNewsDir();
extern int saveArticle _ARGUMENTS((char *, struct newsgroup *, art_num));
extern void resetSaveFlag();
#endif /* SAVEARTICLE_H */

...
#ifdef _XMU_VMS_PRAGMA_START_
### XMU_VMS_PRAGMA_S.H: Error, _XMU_VMS_PRAGMA_START_ already defined
#endif

#ifdef _XMU_VMS_PRAGMA_END_
### XMU_VMS_PRAGMA_S.H: Error, _XMU_VMS_PRAGMA_END_ defined
#endif  

#define _XMU_VMS_PRAGMA_START_

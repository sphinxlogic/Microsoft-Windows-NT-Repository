...
/* ARGSUSED */
void _Xaw3dComputeTopShadowRGB (scn, pixel, icontrast, xcol_out)
    Screen *scn;
    unsigned long pixel;
    int icontrast;
    XColor *xcol_out;
    ...
    Widget new;
{
    ...
    _Xaw3dComputeTopShadowRGB (XtScreen(new),
...
/* ARGSUSED */
void _Xaw3dComputeBotShadowRGB (scn, pixel, icontrast, xcol_out)
    Screen *scn;
    unsigned long pixel;
    int icontrast;
    XColor *xcol_out;
    ...
    Widget new;
{
    ...
    _Xaw3dComputeBotShadowRGB (XtScreen(new), 
			       tdw->core.background_pixel, 

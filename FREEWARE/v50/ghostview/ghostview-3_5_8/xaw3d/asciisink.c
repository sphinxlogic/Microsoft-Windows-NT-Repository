...
#   include <XAW_DIRECTORY/AsciiSinkP.h>
#   include <XAW_DIRECTORY/AsciiSrcP.h>	/* For source function defs. */
#   include <XAW_DIRECTORY/TextP.h>	/* I also reach into the text widget. */
#else
#   include <X11/Xlib.h>
#   include <X11/Xutil.h>
#   include <X11/Xatom.h>

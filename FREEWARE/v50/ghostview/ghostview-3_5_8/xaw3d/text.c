...
#   include <X11_DIRECTORY/Xatom.h>
#   include <XMU_DIRECTORY/Atoms.h>
#   include <XMU_DIRECTORY/CharSet.h>
#   include <XMU_DIRECTORY/Converters.h>
#   include <XMU_DIRECTORY/StdSel.h>
...
#   include <XMU_DIRECTORY/vms_compat.h>
#   include <stdlib.h> /*###jp### inserted 22.10.94 */
#else
...
#endif 
_EXTERN_ char *_XawDefaultTextTranslations1, *_XawDefaultTextTranslations2,
...
int *format;
{
  ...
  if (*target == XA_TARGETS(d)) {
    ...
    *targetP++ = XA_CHARACTER_POSITION(d);
    ...
    (void) bcopy((char*)std_targets, (char*)targetP, sizeof(Atom)*std_length);

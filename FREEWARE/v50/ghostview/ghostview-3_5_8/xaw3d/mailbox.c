...
#ifdef VMS
#   include <X11_DIRECTORY/IntrinsicP.h>	/* for toolkit stuff */
#   include <X11_DIRECTORY/StringDefs.h>	/* for useful atom names */
#   if (XlibSpecificationRelease<5) /*###jp### inserted 22.10.94*/
#      define _XtStringDefs_h_
#   endif
#   include <X11_DIRECTORY/cursorfont.h>	/* for cursor constants */
#   include <X11_DIRECTORY/Xosdefs.h>		/* for X_NOT_POSIX def */
#   include <stat.h>				/* for stat() ** needs types.h ***/
#else
...
#ifdef VMS /*###jp###*/
#       include	<XAW_DIRECTORY/vms_wait.h>
...
#ifdef VMS /* (don't forget the dot after a filename) */
#   include <BITMAP_DIRECTORY/mailfull.>	/* for flag up (mail present) bits */
#   include <BITMAP_DIRECTORY/mailempty.>	/* for flag down (mail not here) */
#   include <X11_DIRECTORY/cursorfont.h>	/* for cursor constants */
#   include <XAW_DIRECTORY/XawInit.h>
#   include <XAW_DIRECTORY/MailboxP.h>		/* for implementation mailbox stuff */

! DESCRIP.MMS
CC = cc/debug/warn=disable=(ptrmismatch,notconstqual)
COMMONFILES = dc.th,configdc.th,locdcFil.mng
dcd.exe depends_on dccFiles.mngOrig,dcblk.obj,dcdecl.obj,dcdir.obj,dcexp.obj,-
	dcext.obj,dcfmt.obj,dcinst.obj,dcmain.obj,dcprag.obj,dcrec.obj,-
	dcrecdir.obj,dctxttok.obj
  ...
  link/exe=dcd/debug dcblk.obj,dcdecl.obj,dcdir.obj,dcexp.obj,dcext.obj,-
	...
	dctxttok.obj
dccFiles.mngOrig depends_on dccFiles.mng
  copy dccFiles.mng locdcFil.mng
  copy dccFiles.mng dccFiles.mngOrig

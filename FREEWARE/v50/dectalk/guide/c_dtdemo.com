$	save_verify = 'f$verify(0) + f$verify(0'c_dtdemo_verify' .gt. 0)
$!
$! c_dtdemo.com P1
$! This command file starts the DECtalk demo on one or more
$! terminal lines.  It reads the terminal lines from a configuration
...
$!
$!      tta4: dictionary.user	! DECtalk connected to tta4:
$!      tta7:           	! DECtalk connected to tta7:
$!
$! where "tta4:" and "tta7:" are the terminal lines that DECtalk is 
...
$       write com "$ cdemo :== $''dir'cdemo.exe"
$	write com "$ cdemo ''tty': ''dict'"
$	close com
$	run/detach			-
	    /input=DEMO_'tty'.com	-
	    /output='tty'.err		-

	...
	Modifying the DECtalk Insurance Demo (changing menu item selections)
	-------------------------------------------------------------------
	...
	2.  Modify the configuration file (demo_insurance.cfg) to contain
	...
	5.  To start up the demo, enter the following two DCL commands:
	    ...
	    $ set proc/priv=all
	    $ @demo_insurance demo_insurance.cfg

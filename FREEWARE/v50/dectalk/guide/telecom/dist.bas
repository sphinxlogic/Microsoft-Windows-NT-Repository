!  ----------------------------  DIST.BAS  ------------------------
!
!  This function contains the distribution services section of the
...
%INCLUDE "DTKDEF"
    ...
    dist_menu$	  = "For order entry, press 1. "&
		  ...
		  + "with the pound-key.  To exit the distribution "&
		  + "demonstration, press the star-key.  "
...
%INCLUDE "DTKDEF"
    ...
    new_ship$   = "A new shipment is expected in 7 days. [:nh +] If the "&
	        + "parts had been in stock, DECtalk [wuhdax<60>v] said how "&
		+ "many were in stock. "
...
%INCLUDE "DTKDEF"
    ...
    order_no$	  = "Please enter the order number, followed by the "&
		  + "pound-key.  You may enter any number up to 6 digits. "

    shipped$	  = "Order number              was shipped "

    order_status$ = "[:nh +] If the order had not been shipped, DECtalk "&
		  + "[wuhdax<60>v] informed the caller of the expected "&
		  + "shipping date, or any problems with the order. "

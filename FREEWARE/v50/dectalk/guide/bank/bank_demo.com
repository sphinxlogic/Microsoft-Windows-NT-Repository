...
$!
$! @bank_demo.com P1
$! This command file starts the DECtalk banking demo on one or more
...
$! 
$! Create a command procedure that will start up the DECtalk banking demo
...
$       write com "$ bank_demo :== $''dir'bank_demo.exe"
$	write com "$ bank_demo ''tty': ''dict'"
$	close com
$	run/detach			-
	    /input=DEMO_'tty'.com	-
	    /output='tty'.err		-

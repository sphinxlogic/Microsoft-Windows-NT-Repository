...
$!
$ say ""
$ say "      Installing Logical Disk Utility version V6.3"
$ say ""
$!
$ vmi$callback set purge ask
$!
$ vmi$callback check_vms_version version_check "062" ! minimum needed
$!
$ if .not. version_check
$ then
$   vmi$callback message e incvmsver -
$         "This installation requires at least VMS version V6.2"
$   exit vmi$_failure
$ endif
$ !
$ platform = "vax"
...
$ if vms_version .eqs. "073" .and. platform .eqs. "alpha" then goto alpv73
$ if vms_version .eqs. "055" .and. platform .eqs. "vax" then goto nosupport
$ if vms_version .eqs. "060" .and. platform .eqs. "vax" then goto nosupport
$ if vms_version .eqs. "061" .and. platform .eqs. "vax" then goto nosupport
$ if vms_version .eqs. "062" .and. platform .eqs. "vax" then goto vaxv62
$ if vms_version .eqs. "070" .and. platform .eqs. "vax" then goto nosupport
$ if vms_version .eqs. "071" .and. platform .eqs. "vax" then goto vaxv71
$ if vms_version .eqs. "072" .and. platform .eqs. "vax" then goto vaxv72
$ if vms_version .eqs. "073" .and. platform .eqs. "vax" then goto vaxv73
$!
$ say ""
$ say "***********************************************************************"
...
$ say "***********************************************************************"
$ say ""
$! Other (higher) versions take the V7.3 image
$ if platform .eqs. "vax" then goto vaxv73
$ if platform .eqs. "alpha" then goto alpv73
...
$ say "      yourself from the sources provided in the LD063.B saveset."
$ say ""
$ exit vmi$_failure
$!
$alpv62:

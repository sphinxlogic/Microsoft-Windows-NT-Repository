...
/*
 * For OpenVMS, we need the following defined.
 */
...
/*
 * Just to be nice and neat, under OpenVMS make the title, class name and icon
 * name reflect that this is a MEGA version of POV-Ray.
 */
#if defined(VMS) && defined(DECC)
#  define theTITLE      "Mega Persistence of Vision"
#  define theICONNAME   "MegaPOV-Ray"     /* Short name for the icon */
#  define theCLASS      "MegaPovray"      /* Should begin with a capital */
#  define theNAME       "megapovray"      /* Can be overridden with -name <name> */
#else

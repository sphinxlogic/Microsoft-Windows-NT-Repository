...
$!
$! mcr ncp define object x_remote_decterm number 0 -
$!	file DEV:[dir]X_REMOTE_DECTERM.COM -
$!	proxy both alias incom enab
$!
$! Decnet Phase V:
$!
$! MCR NCL CREATE SESSION CONTROL APPLICATION X_REMOTE_DECTERM
$! MCR NCL SET SESSION CONTROL APPLICATION X_REMOTE_DECTERM -
$!	ADDRESSES = {NAME = X_REMOTE_DECTERM} -
$!	,OUTGOING PROXY = TRUE -
$!	,INCOMING PROXY = TRUE -
$!	,INCOMING ALIAS = TRUE -
$!	,NODE SYNONYM = TRUE -
$!	,IMAGE NAME = NET_TOOLS:X_REMOTE_DECTERM.COM
$!
...
$! x_remote_decterm to launch this object.
$!
...
$!=============================================================================
$!
$obj_name = "x_remote_decterm"
$!
$!DEFINE SYS$OUTPUT SYS$LOGIN:REMOTE_DECTERM.LOG
$!
...
$	vue$set_task_label "Creating Remote Decterm - ''remote_node'"
$	vue$set_output_title "Creating Remote Decterm - ''remote_node'"
$   endif
$!
...
$	if f$element(1,".",remote_node) .nes. "."
$	then
$!
$!	    UCX 3.x
$!------------------
...
$CREATE/TERMINAL=DECTERM/DETACH/INSERT/LINE_EDITING/LOGGED_IN-

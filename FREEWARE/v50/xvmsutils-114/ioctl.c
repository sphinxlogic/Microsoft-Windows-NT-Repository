...
/*
 * Code merged (with small changes) from Mosaic and Xpilot distribution.
 * (Bjorn S. NIlsson and c.hjorring@auckland.ac.nz)
 * Based on an example in the UCX manual.
 * 960814 Martin P.J. Zinser (m.zinser@gsi.de)
 */

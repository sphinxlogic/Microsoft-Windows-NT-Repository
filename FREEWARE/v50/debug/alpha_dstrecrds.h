...
/**                                                                          **/
/********************************************************************************************************************************/
/* Created:  8-JUN-1998 10:33:25 by OpenVMS SDL EV1-53     */
...
typedef struct _DST$HEADER {
    union  {
        unsigned short int dst$w_length;
        unsigned short int dst$x_length;
        } dst$$header_length;
    union  {
        DST$DTYPE dst$w_type;
        DST$DTYPE dst$x_type;
        } dst$$header_type;
    } DST$HEADER;
#define DST$K_DST_BASE_FOR_NEXT 2
#define DST$K_DST_HEADER_SIZE 4
#define DST$K_LENGTH_LENGTH 2
#define DST$K_LENGTH_TYPE 2
	
	
typedef unsigned int DST$LANGUAGE;
...
typedef struct _DST$MODULE_BEGIN {
    ...
    unsigned char dst$b_modbeg_unused;
    DST$LANGUAGE dst$l_modbeg_language;
    unsigned short int dst$w_version_major;
    unsigned short int dst$w_version_minor;
    unsigned char dst$b_modbeg_name;
    } DST$MODULE_BEGIN;
#define DST$K_MODBEG_SIZE 15
	
typedef struct _DST$MB_TRLR {
    unsigned char dst$b_compiler;
    } DST$MB_TRLR;
#define DST$K_MB_TRLR_SIZE 1
#define DST$K_MAJOR_ID_0 0
#define DST$K_MAJOR_ID_1 1
#define DST$K_MIN_MAJOR_ID 0
#define DST$K_MAX_MAJOR_ID 1
#define DST$K_MAJOR_ID_0_MINOR_ID_0 0
#define DST$K_MAJOR_ID_0_MINOR_ID_1 1
#define DST$K_MAJOR_ID_0_MINOR_ID_2 2
#define DST$K_MAJOR_ID_0_MINOR_ID_3 3
#define DST$K_MAJOR_ID_0_MIN_MINOR_ID 0
#define DST$K_MAJOR_ID_0_MAX_MINOR_ID 3
#define DST$K_MAJOR_ID_1_MINOR_ID_0 0
#define DST$K_MAJOR_ID_1_MINOR_ID_1 1
#define DST$K_MAJOR_ID_1_MINOR_ID_2 2
#define DST$K_MAJOR_ID_1_MINOR_ID_3 3
#define DST$K_MAJOR_ID_1_MINOR_ID_4 4
#define DST$K_MAJOR_ID_1_MINOR_ID_5 5
#define DST$K_MAJOR_ID_1_MINOR_ID_6 6
#define DST$K_MAJOR_ID_1_MINOR_ID_7 7
#define DST$K_MAJOR_ID_1_MINOR_ID_8 8
#define DST$K_MAJOR_ID_1_MINOR_ID_9 9
#define DST$K_MAJOR_ID_1_MINOR_ID_10 10
#define DST$K_MAJOR_ID_1_MINOR_ID_11 11
#define DST$K_MAJOR_ID_1_MINOR_ID_12 12
#define DST$K_MAJOR_ID_1_MINOR_ID_13 13
#define DST$K_MAJOR_ID_1_MINOR_ID_14 14
#define DST$K_MAJOR_ID_1_MINOR_ID_15 15
#define DST$K_MAJOR_ID_1_MINOR_ID_16 16
#define DST$K_MAJOR_ID_1_MINOR_ID_17 17
#define DST$K_MAJOR_ID_1_MINOR_ID_18 18
#define DST$K_MAJOR_ID_1_MAX_MINOR_ID 18
#define DST$K_MAJOR_FIELD_TEST 0
#define DST$K_MINOR_FIELD_TEST 3
#define DST$K_VERSION_MAJOR 1
#define DST$K_VERSION_MINOR 18
typedef struct _DST$MODULE_END {
    DST$HEADER dst$a_modend_header;
    } DST$MODULE_END;
#define DST$K_MODEND_SIZE 4
...
typedef struct _DST$VARIANT_VALUE {
    ...
    unsigned int dst$l_varval_size;
    unsigned short int dst$w_varval_count;
    } DST$VARIANT_VALUE;
#define DST$K_VARIANT_VALUE_SIZE 10
...
#define DST$K_VARSET_END_SIZE 4
...
#define DST$K_REG_ALPHA_R16 52
#define DST$K_REG_ALPHA_R17 53
#define DST$K_REG_ALPHA_R18 54
#define DST$K_REG_ALPHA_R19 55
#define DST$K_REG_ALPHA_R20 56
#define DST$K_REG_ALPHA_R21 57
#define DST$K_REG_ALPHA_R22 58
#define DST$K_REG_ALPHA_R23 59
#define DST$K_REG_ALPHA_R24 60
#define DST$K_REG_ALPHA_R25 61
#define DST$K_REG_ALPHA_R26 62
#define DST$K_REG_ALPHA_R27 63
#define DST$K_REG_ALPHA_R28 64
#define DST$K_REG_ALPHA_R29 65
#define DST$K_REG_ALPHA_R30 66
#define DST$K_REG_ALPHA_R31 67
#define DST$K_REG_ALPHA_F0 68
#define DST$K_REG_ALPHA_F1 69
#define DST$K_REG_ALPHA_F2 70
#define DST$K_REG_ALPHA_F3 71
#define DST$K_REG_ALPHA_F4 72
#define DST$K_REG_ALPHA_F5 73
#define DST$K_REG_ALPHA_F6 74
#define DST$K_REG_ALPHA_F7 75
#define DST$K_REG_ALPHA_F8 76
#define DST$K_REG_ALPHA_F9 77
#define DST$K_REG_ALPHA_F10 78
#define DST$K_REG_ALPHA_F11 79
#define DST$K_REG_ALPHA_F12 80
#define DST$K_REG_ALPHA_F13 81
#define DST$K_REG_ALPHA_F14 82
#define DST$K_REG_ALPHA_F15 83
#define DST$K_REG_ALPHA_F16 84
#define DST$K_REG_ALPHA_F17 85
#define DST$K_REG_ALPHA_F18 86
#define DST$K_REG_ALPHA_F19 87
#define DST$K_REG_ALPHA_F20 88
#define DST$K_REG_ALPHA_F21 89
#define DST$K_REG_ALPHA_F22 90
#define DST$K_REG_ALPHA_F23 91
#define DST$K_REG_ALPHA_F24 92
#define DST$K_REG_ALPHA_F25 93
#define DST$K_REG_ALPHA_F26 94
#define DST$K_REG_ALPHA_F27 95
#define DST$K_REG_ALPHA_F28 96
#define DST$K_REG_ALPHA_F29 97
#define DST$K_REG_ALPHA_F30 98
#define DST$K_REG_ALPHA_F31 99
#define DST$K_REG_ALPHA_PC 100
#define DST$K_REG_ALPHA_PS 101
#define DST$K_REG_ALPHA_FPCR 102
#define DST$K_REG_ALPHA_SFPCR 103
#define DST$K_REG_ALPHA_MIN 36
#define DST$K_REG_ALPHA_MAX 103
#define DST$K_REG_ALPHA_AI 61
#define DST$K_REG_ALPHA_RA 62
#define DST$K_REG_ALPHA_PV 63
#define DST$K_REG_ALPHA_FP 65
#define DST$K_REG_ALPHA_SP 66
#define DST$K_REG_ALPHA_REGNUM_FP 13
#define DST$K_REG_ALPHA_REGNUM_SP 14
	
#define DST$K_REG_ALPHA_MIN_SCALAR 36
#define DST$K_REG_ALPHA_MAX_SCALAR 67
#define DST$K_REG_ALPHA_MIN_FLOAT 68
#define DST$K_REG_ALPHA_MAX_FLOAT 99
...
typedef struct _DST$DESCRIPTOR_FORMAT {
    ...
    unsigned int dst$l_dsc_offs;
    } DST$DESCRIPTOR_FORMAT;
#define DST$K_DESCRIPTOR_FORMAT_SIZE 9
	
	
typedef struct _DST$TRAILING_VALSPEC {
    DST$DATA_HEADER dst$a_tvs_header;
    unsigned int dst$l_tvs_offset;
    } DST$TRAILING_VALSPEC;
#define DST$K_TRAILING_VALSPEC_SIZE 9
	
#define DST$K_SEPTYP_SIZE 10
...
typedef struct _DST$VAL_SPEC {
    ...
    union  {
        unsigned int dst$l_vs_value;
        unsigned int dst$l_vs_dsc_offs;
        unsigned int dst$l_vs_tvs_offset;
        struct  {
            unsigned short int dst$w_vs_length;
            DST$VS_ALLOC_KIND dst$b_vs_alloc;
            union  {
                unsigned char dst$b_vs_mbz;
...
typedef struct _DST$BIND_SPEC_STRUCT {
    unsigned short int dst$w_bs_num_bindings;
    } DST$BIND_SPEC_STRUCT;
#define DST$K_BIND_SPEC_STRUCT_SIZE 2
	
typedef struct _DST$BIND_SPEC {
    unsigned int dst$l_bs_lo_pc;
    unsigned int dst$l_bs_hi_pc;
    unsigned short int dst$w_bs_num_pc_bindings;
    } DST$BIND_SPEC;
#define DST$K_BIND_SPEC_SIZE 10
...
typedef struct _DST$XVS_SPEC {
    ...
    struct  {
        int dst$l_xvs_low_value;
        int dst$l_xvs_hi_value;
        } dst$q_xvs_value;
    } DST$XVS_SPEC;
...
typedef struct _DST$TYPE_SPEC {
    ...
    union  {
        ...
        struct  {
            unsigned int dst$l_ts_ind_ptr;
            } dst$indirect_type;
        struct  {
            unsigned int dst$l_ts_xmod_offset;
        ...
        struct  {
            unsigned int dst$l_ts_set_leng;
            } dst$set_type;
        struct  {
            unsigned int dst$l_ts_subr_leng;
            } dst$subrange_type;
        struct  {
            DBG$DST_LANGUAGE dst$b_ts_file_lang;
            } dst$file_type;
        struct  {
            unsigned int dst$l_ts_nov_leng;
            unsigned int dst$l_ts_nov_leng_par_tspec;
            } dst$novel_length_type;
        struct  {
            DST$VAL_SPEC dst$a_dyn_nov_val_spec;
            } dst$dynamic_novel_length_type;
        struct  {
            unsigned int dst$l_ts_self_leng;
            } dst$self_relative_type;
        struct  {
            unsigned short int dst$wu_ts_task_entry_count;
            } dst$task_type;
        struct  {
            unsigned int dst$l_ts_constr_record;
            unsigned int dst$l_ts_constr_count;
            } dst$constrained_type;
        struct  {
            unsigned int dst$l_ts_mightbe_record;
            } dst$might_be_constrained_type;
        struct  {
            unsigned char dst$b_ts_scan_tree_depth;
            } dst$scan_tree_type;
        struct  {
            unsigned int dst$l_ts_incomplete_ptr;
            } dst$incomplete_type;
        struct  {
            unsigned int dst$l_ts_number_units;
...
typedef struct _DST$BLI_FIELDS {
    ...
    union  {
        struct  {
            unsigned int dst$l_bli_vec_units;
            struct  {
        ...
        struct  {
            unsigned int dst$l_bli_bitvec_size;
            } dst$bli_struc_bitvector;
        struct  {
            unsigned int dst$l_bli_block_units;
            struct  {
...
#define DST$K_SOURCE_CORR_HEADER_SIZE 4
...
#define DST$K_GEM_LOC_HEADER_SIZE 4
...
typedef struct _DST$PCLOC_COMMANDS {
    ...
    union  {
        ...
        struct  {
            unsigned int dst$l_pcloc_pntl_line;
        ...
        struct  {
            unsigned int dst$l_pcloc_rngl_low_line;
            unsigned short int dst$w_pcloc_rngl_low_column;
            unsigned int dst$l_pcloc_rngl_high_line;
        ...
        struct  {
            unsigned int dst$l_pcloc_setpc32_value;
            } dst$a_pcloc_setpc32;
        struct  {
            unsigned int dst$l_pcloc_event_read_sym1;
            unsigned int dst$l_pcloc_event_read_sym2;
            } dst$a_pcloc_event_read;
        struct  {
            unsigned int dst$l_pcloc_event_write_sym;
...
typedef struct _DST$EPILOG {
    ...
    unsigned int dst$lu_epilog_count;
    } DST$EPILOG;
#define DST$K_EPILOG_SIZE 9
	
typedef struct _DST$EPI_SINGLETON {
    unsigned int dst$lu_epilog_single_addr;
    } DST$EPI_SINGLETON;
#define DST$K_EPILOG_SINGLETON_SIZE 4
	
typedef struct _DST$EPI_PAIR {
    unsigned int dst$lu_epilog_pair_low_addr;
    unsigned int dst$lu_epilog_pair_high_addr;
    } DST$EPI_PAIR;
...
typedef struct _DST$RETURN {
    ...
    unsigned int dst$lu_return_count;
    } DST$RETURN;
#define DST$K_RETURN_SIZE 9
...
#define DST$K_REGISTER_SAVE_BEGIN_SIZE 6
...
typedef struct _DST$BASE_CLASS {
    ...
    unsigned int dst$l_base_class_dst;
    unsigned int dst$l_base_class_value;
    } DST$BASE_CLASS;
#define DST$K_BASE_CLASS_SIZE 13
typedef struct _DST$VIRT_FUNC {
    DST$HEADER dst$w_virt_func_header;
    struct  {
        unsigned dst$v_virt_func_unused : 8;
        } dst$b_virt_func_flags;
    unsigned int dst$l_virt_func_index;
    } DST$VIRT_FUNC;
#define DST$K_VIRT_FUNC_SIZE 9

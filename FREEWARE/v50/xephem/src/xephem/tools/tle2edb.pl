...
#
# (c) 1993,1995,1998 Elwood Charles Downey
#
...
while (<>) {
    ...
    printf "%s-%d,E,1/%s/%d,%s,%s,%s,%s,%s,%s,%s,%d\n", $name, $set, $dayno,
			  $year, $inc, $ra, $e, $ap, $anom, $n, $decay, $rev;
}
...
# @(#) $RCSfile: tle2edb.pl,v $ $Date: 1998/12/10 20:06:55 $ $Revision: 1.2 $ $Name:  $

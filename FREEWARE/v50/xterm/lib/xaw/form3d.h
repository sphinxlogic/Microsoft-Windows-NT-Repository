/* $XConsortium: Form3d.h,v 1.28 91/05/04 18:59:10 rws Exp $ */
...
typedef struct _Form3dClassRec	*Form3dWidgetClass;
typedef struct _Form3dRec	*Form3dWidget;

extern WidgetClass form3dWidgetClass;
...
extern void _Form3dTopShadowRGB (
#if NeedFunctionPrototypes
    Widget 		/* new */,
    XColor*		/* xcol_out */
#endif
...
extern void _Form3dBottomShadowRGB (
#if NeedFunctionPrototypes
    Widget		/* new */,
    XColor*		/* xcol_out */
#endif

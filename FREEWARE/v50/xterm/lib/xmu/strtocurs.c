...
#ifdef VMS
#   include	<X11_DIRECTORY/IntrinsicP.h>   /* 'cause CoreP.h needs it */
#   include	<X11_DIRECTORY/CoreP.h>        /* just to do XtConvert() */
...
#   include	<XMU_DIRECTORY/Curutil> /*###jp### inserted 20.10.94 */
#   include     <limits.h>
#else
...
#   endif
#else /* DRM, silly, if PATH_MAX from limits MAXPATHLEN never gets defined! */

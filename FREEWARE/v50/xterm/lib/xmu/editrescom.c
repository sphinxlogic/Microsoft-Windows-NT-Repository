...
#   include <X11_DIRECTORY/ShellP.h>
#   include <X11_DIRECTORY/Xatom.h>
#   include <X11_DIRECTORY/Xos.h>
#   include <XAW_DIRECTORY/Cardinals.h>
#   include <XMU_DIRECTORY/EditresP.h>
#   include <XMU_DIRECTORY/Charset.h> /*###jp### inserted 20.10.94 */
#else
#   include <X11/IntrinsicP.h>	/* To get into the composite and core widget structures. */
...
/* DRM		    info->event->value, info->event->name);   */
	else

/* Modified version from patrick@teaching.fce.unsw.edu.au (Patrick Young)
This one compiles ok, probably because it is missing all of the LayYY 
related code and defines. 20-JAN-2000, Mathog.
*/
/*

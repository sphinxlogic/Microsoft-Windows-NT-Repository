...
#ifdef VMS
#   include <X11_DIRECTORY/IntrinsicP.h>	/* get basic toolkit stuff */
#   include <X11_DIRECTORY/StringDefs.h>	/* get XtN and XtC defines */
#   include <XAW_DIRECTORY/XawInit.h>		/* get Xaw initialize stuff */
#   include <XAW_DIRECTORY/PortholeP.h>		/* get porthole structs */
#   include <XMU_DIRECTORY/Misc.h>		/* for MAX */
#else

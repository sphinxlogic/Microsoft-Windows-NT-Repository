...
$ endif
$!
$! note the use of case sensitive variables, Scroll, Index,
$! and Setenv in the source file, and so the required DEFINES
$! to avoid collision with existing functions scroll,index, and
$! setenv.
$!
$ if(P1 .nes. "")
$ then
...
$ endif
$ mycc :== 'ccstub' -
/define=(VMS,"""Setenv=XtermSetenv""","""Scroll=XtermScroll""",-
 """Index=XtermIndex""",-
 OPT_TEK4014,ALLOWLOGGING,OPT_NUM_LOCK)
$!

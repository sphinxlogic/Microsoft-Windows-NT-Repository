...
$       t1inc = dir
$     else
$       write sys$output "Can not find t1lib.h in directory ''dir' - Exiting"
$       exit
$     endif
$     goto t1_loop
$   endif       
...
$       t1olb = dir
$     else
$       write sys$output "Can not find t1 object library ''dir' - Exiting"
$       exit
$     endif
$     goto t1_loop
$   endif       
...
$ if (xpm_def) then write optf "LibXPM:LibXPM.olb/Library"
$ if (t1inc.nes."").and.(t1olb.nes."") then write optf t1olb, "/Library"
$! freetype
$ if (freeinc.nes."").and.(freeinc2.nes."").and.(freeolb.nes."") then write optf freeolb, "/Library"
$ write optf "Sys$Share:DECW$XLibShr.EXE/Share"
$!
$ if its_decc
$  then
$   My_CC   :== "CC /DECC /NoList /PREFIX = ALL ''float' ''defs' ''incs'"
$!
...
$   My_CXX :== "CXX /PREFIX = ALL /NoList ''cxxdefs' ''float' ''defs' ''incs'"
$ endif
$!
$ if its_gnuc
$  then
$   My_CC   :== "GCC /NOCASE ''defs' ''incs'" 
$   My_CXX :== "GCC /PLUSPLUS /NOCASE ''defs' ''incs'"
...
$ @vms_make
$ set default [-]
$ delete/sym/glob My_CC
$ delete/sym/glob My_CXX
$ delete/sym/glob My_Link
$ exit

...
$ if (f$trnlnm ("X11") .eqs. "") then define x11 decw$include,'path'
$!
$! Check for MMK/MMS
$!
...
$   CALL MAKE SXPM.EXE "LINK  sxpm,xpm_app.opt/OPT" sxpm.OBJ
$   CALL MAKE CXPM.OBJ "CC  ''CCOPT' [-.cxpm]cxpm" -
                [-.cxpm]cxpm.c xpmi.h *.c
$   write sys$output "Linking CXPM ..."
$   CALL MAKE CXPM.EXE "LINK  cxpm,xpm_app.opt/OPT" cxpm.OBJ
$  endif

...
$ input_spec = f$parse(input_spec, ".COM",,, "no_conceal")
$ input_spec = f$search(input_spec, 191817)
$ if (input_spec .eqs. "") then goto no_thing
$ if (f$trnlnm("dbslog") .eqs. "") then define/nolog dbslog sys$login
$ output_spec = f$parse("dbslog",,, "device", "no_conceal") -
		+ f$parse("dbslog",,, "directory", "no_conceal") -

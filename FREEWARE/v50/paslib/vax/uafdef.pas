...
*  Version 5 User Authorization Files.					*
*  The following documents should be refered to:			*
*									*
*	Authorize Utility Manual;		)			*
*	$UAFDEF module of SYS$LIBRARY:LIB.MLB;	 )  Version 5		*
...
Flag = (Disctly,	{  0: Disable future CTRL/Y interrupts }
	...
	Audit,		{ 11: Enables auditing of security relevant actions }
...
Privilege = (Cmkrnl,	{  0: May change Mode to Kernel }
	     ...
	     Pbit32,	{ 32-33: dummy bits (UPGRADE and DOWNGRADE in SE/VMS) }
	     Pbit33,
	     Grpprv,	{ 34: Group access via system protection field }
	     Readall,	{ 35: Read access to everything }
	     Pbit36,	{ 36-37: dummy bits }
	     Pbit37,

...
*			=========================			*
*									*
*  The Pascal User Environment contains declarations for all OpenVMS	*
*  Run-Time Library and Utility routines (with some minor exceptions	*
*  as detailed below), not defined by Digital, and useful Constant and	*
*  Type definitions.							*
*									*
...
*.......................................................................*
*									*
*  Written in DEC Pascal for OpenVMS machines.				*
*									*
...
*									*
*  History:								*
*	24-May-1995	JER	Original version from HERMES.		*
************************************************************************}

[ ENVIRONMENT	('PASLIB'),
  INHERIT	('SYS$LIBRARY:STARLET',
		 'SYS$LIBRARY:PASCAL$ACLEDIT_ROUTINES',
		 'SYS$LIBRARY:PASCAL$CLI_ROUTINES',
		 'SYS$LIBRARY:PASCAL$CMA_ROUTINES',
		 'SYS$LIBRARY:PASCAL$CONV_ROUTINES',
		 'SYS$LIBRARY:PASCAL$CVT_ROUTINES',
		 'SYS$LIBRARY:PASCAL$C_ROUTINES',
		 'SYS$LIBRARY:PASCAL$DCX_ROUTINES',
		 'SYS$LIBRARY:PASCAL$DTK_ROUTINES',
		 'SYS$LIBRARY:PASCAL$D_FLOAT',
		 'SYS$LIBRARY:PASCAL$EDT_ROUTINES',
		 'SYS$LIBRARY:PASCAL$FDL_ROUTINES',
		 ...
		 'SYS$LIBRARY:PASCAL$PSM_ROUTINES',
		 'SYS$LIBRARY:PASCAL$SMB_ROUTINES',
		 'SYS$LIBRARY:PASCAL$SMG_ROUTINES',
		 'SYS$LIBRARY:PASCAL$SOR_ROUTINES',
		 'SYS$LIBRARY:PASCAL$STR_ROUTINES',
		 'SYS$LIBRARY:PASCAL$TPU_ROUTINES') ]

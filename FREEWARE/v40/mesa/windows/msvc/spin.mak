...
!MESSAGE 
!MESSAGE NMAKE /f "spin.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/spin.exe $(OUTDIR)/spin.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /I "\wing\include" /I "..\..\include" /D\
 ...
 /Fp$(OUTDIR)/"spin.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"spin.bsc" 
BSC32_SBRS= \
	$(INTDIR)/spin.SBR

$(OUTDIR)/spin.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"spin.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"spin.exe" 
DEF_FILE=
LINK32_OBJS= \
	\WING\LIB\WING32.LIB \
...
$(OUTDIR)/spin.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /I "\wing\include" /I "..\..\include" /D\
 ...
 /Fp$(OUTDIR)/"spin.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"spin.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"spin.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"spin.exe" 
DEF_FILE=
LINK32_OBJS= \
	\WING\LIB\WING32.LIB \
	$(INTDIR)/spin.OBJ \
...
SOURCE=\Mesa\windows\DEMOS\spin.C
DEP_BOUNC=\
	\Mesa\include\gltk.h\
	C:\MSDEV\INCLUDE\gl\GL.H\
	C:\MSDEV\INCLUDE\gl\GLU.H

$(INTDIR)/spin.OBJ :  $(SOURCE)  $(DEP_BOUNC) $(INTDIR)
   $(CPP) $(CPP_PROJ)  $(SOURCE) 

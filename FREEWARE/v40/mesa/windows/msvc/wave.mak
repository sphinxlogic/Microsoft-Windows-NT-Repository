...
!MESSAGE 
!MESSAGE NMAKE /f "wave.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/wave.exe $(OUTDIR)/wave.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /I "\wing\include" /I "..\..\include" /D\
 ...
 /Fp$(OUTDIR)/"wave.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"wave.bsc" 
BSC32_SBRS= \
	$(INTDIR)/wave.sbr

$(OUTDIR)/wave.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"wave.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"wave.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\winglu.lib \
...
$(OUTDIR)/wave.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /I "\wing\include" /I "..\..\include" /D\
 ...
 /Fp$(OUTDIR)/"wave.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"wave.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"wave.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"wave.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\winglu.lib \
	\WING\LIB\WING32.LIB \

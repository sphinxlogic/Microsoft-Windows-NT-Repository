 ...
 * rising sun and alt of sun at that location. Any pointer may be 0 if not
 * interested. From Bruning and Talcott, October 1995 _Astronomy_, page 76.
 * N.B. lunar coordinates use +E, but selenograhic colongs are +W.
 */
void
moon_colong (jd, lt, lg, cp, kp, ap)
double jd;	/* jd */

...
#define MINW		((int) (MINSCALE * flag_width) + 2 * MINAMP + MAXSCALE - 1)
#define MINH		((int) (MINSCALE * flag_height) + 2 * MINAMP + MAXSCALE - 1)

...
$ CLOSE X
$ SET VERIFY
$ LINK/EXEC=NEWSRDR.EXE/NOTRACE'QUAL' 'BIN'NEWSRDR.OLB/INCLUDE=NEWSRDR/LIB,-
...
$ SET VERIFY
$ LINK/EXEC=NEWSRDR.EXE/NOTRACE'QUAL' 'BIN'NEWSRDR.OLB/INCLUDE=NEWSRDR/LIB,-
    	'BIN'SERVER_NETLIB.OBJ,SYS$SCRATCH:NEWSRDR.OPT/OPT
$!'F$VERIFY(0)
$!
$ DELETE SYS$SCRATCH:NEWSRDR.OPT;*
$!

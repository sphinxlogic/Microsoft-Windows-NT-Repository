...
**  	17-JUN-1994 V1.7-1  Madison 	Defaults were applied when hdrs turned off.
**--
*/
#include "newsrdr.h"
#include "globals.h"
...
unsigned int Read_Profile() {
    ...
    short tlen;
    int vms_v52, i, Saw_Hdrs_Line, Saw_Extract_Hdrs_Line;
...
*/
    ...
    Saw_Hdrs_Line = Saw_Extract_Hdrs_Line = 0;
...
*/
    ...
    if (!Saw_Hdrs_Line && news_prof.hdrlist.head == &news_prof.hdrlist) {
    ...
    if (!Saw_Extract_Hdrs_Line && news_prof.ehdrlist.head == &news_prof.ehdrlist) {

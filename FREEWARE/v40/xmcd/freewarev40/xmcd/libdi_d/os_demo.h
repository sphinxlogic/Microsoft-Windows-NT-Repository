...
#ifndef LINT
static char *_os_demo_h_ident_ = "@(#)os_demo.h	6.12 98/01/02";
#endif


#include "libdi_d/os_cdsim.h"	/* CD-ROM simulator header file */
...
extern bool_t	pthru_cdsim_start(void);
extern void	pthru_cdsim_stop(void);

/*----------------------------------------------------------------------
  $Id: os-cvx.h,v 1.8 1993/11/16 00:32:46 hubert Exp $
...
/*----------------------------------------------------------------------
   ...
   OS dependencies, Convex version.  See also the os-cvx.c files.
...
FILE *tmpfile();
extern int errno;
/* Provide these two functions in os.c */
/* typedef long fpos_t; */
...
/*-------------- fpos_t type -----------------------------------*/
#define fpos_t long	/* work around possible conflict */
...
#define CBAUD 0x0000000F	/* Missing definition in Convex include */

...
$!
$!..............................................................................
$!  JUMP has been successfully built and tested under OpenVMS VAX v6.2 with
...
$ if compile
$ then
$   say "Compiling common JUMP source ..."
$   pascal jump /usage=('usage_types') /object=jump.obj_'arch'
$   say "Compiling ''arch' architecture-specific JUMP source ..."
...
$     link         'trace' jump.obj_vax,jump_vax.obj,jump_cld.obj, -
		jump.opt/option,SYS$SYSTEM:SYS.STB/select,SYSDEF.STB/select
$   else
$     link /sysexe 'trace' jump.obj_alpha,jump_alpha.obj,jump_cld.obj, -
		jump.opt/option,SYS$LOADABLE_IMAGES:SYSDEF.STB/select
$   endif
$ endif
$
$ if linking

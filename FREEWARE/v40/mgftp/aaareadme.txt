                  ...
                  Read Before Installing MadGoat FTP V2.2

          Please read the following important information before
          installing or using MadGoat FTP V2.2.

          Installation Information

          MadGoat FTP V2.2 requires the following:

          o  VAX/VMS V5.0 or later or OpenVMS Alpha V1.0 or later
          ...
          install MadGoat FTP V2.2. You will need approximately
          15,000 blocks of disk space to hold the installation
          kit.

          The MGFTP022.% files make up the installation kit,
          which you should install with VMSINSTAL:

              $ @SYS$UPDATE:VMSINSTAL MGFTP022 disk:[dir]

          Manuals are included in save set E (file MGFTP022.E)
...

          ...
          The release notes for MadGoat FTP V2.2 contain
          ...
          saveset MGFTP022.F. The installation gives you the

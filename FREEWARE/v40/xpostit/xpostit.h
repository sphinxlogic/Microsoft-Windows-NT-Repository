...
typedef struct _PostItNote {
	...
	Widget  pn_popupwidget;		/* Popup menu widget. */
	...
	int	pn_shelly;		/* y coord of shell widget	*/
        char	pn_remoteuser[RemoteUserSize];
					/* Name of person who sent msg  */
...
typedef struct {
	...
	String	send_list;		/* path to note directory	*/
	Boolean receive_notes;		/* Receive notes from others	*/
} AppRes, *AppResPtr;
...
extern	Widget rx_popup_menu;
extern	Widget plaidwidget;
extern  char   OurName[RemoteUserSize];

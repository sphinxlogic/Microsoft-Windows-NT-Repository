...
extern "C" {
void XmuDrawRoundedRectangle(Display * _dpy, Window win, GC _gc, int x, int y,
                             int width, int delta, int rh, int rw);
void XmuFillRoundedRectangle(Display * _dpy, Window win, GC _gc, int x, int y,
                             int width, int delta, int rh, int rw);
void XmuDrawLogo();

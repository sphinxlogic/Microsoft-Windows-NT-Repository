...
#ifdef VMS			/* The name is too long */
#define Vminibuffer_local_completion_map	Vminibuf_local_completion_map
#endif
extern Lisp_Object Vminibuffer_local_completion_map;

#ifdef VMS			/* The name is too long */
#define Vminibuffer_local_must_match_map	Vminibuf_local_must_match_map
#endif

...
#ifndef	SCOREFILE
#ifndef VMS
#define	SCOREFILE	"/usr/games/lib/welltris.scores"
#else
#define	SCOREFILE	"SYS$LOGIN:WELLTRIS.SCORE"
#endif /* VMS */
#endif
...
#define	MSG_TITLE	"ALWELLTRIS"
#define	MSG_AUTHOR	"by David A. Bagley"
...
#define	BOXSIZE		18
#define DELTA		1
#define BASE_WIDTH	(MAX_WIDTH*BOXSIZE+DELTA)
#define ENDPT		(3*BASE_WIDTH)
#define GAME_WIDTH	(ENDPT+2*DELTA)
#define MIDPT		(ENDPT/2+DELTA)
#define	OFFSET		20
...
/*** variables defined in "welltris.c" ***/

extern Display *display;
extern int      screen_num;
extern Bool     useColor;
extern Bool	cw, gradualAppear;
...
extern int      level, score, rows, squares;
extern Bool     showNext, beep, diagonal, mixed, bonus, bonusNow, grid;
...
extern Bool     allFrozen();
extern void     checkFreeze();

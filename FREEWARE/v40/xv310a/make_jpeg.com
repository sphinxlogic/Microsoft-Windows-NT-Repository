...
$!           13-Sep-1995   by Brian J. McCarthy
$!                            (mccarthy@hndymn.enet.dec.com)
$!                            Add /prefix=all for DECC compiles 
...
$   Then        ! it's an ALPHA
$       QUALIFIERS = "/Prefix=ALL /Warnings = NoInformationals /Standard = VAXC /NoDebug"
$       Define /NoLog Sys DECC$Library_Include
$   Else        ! it's a VAX
$               ! check for DEC C  if DEC C use the VAX C option
$       If F$Search ("SYS$SYSTEM:DECC$COMPILER.EXE") .nes. ""
$           Then
$               QUALIFIERS = "/Prefix=ALL /Standard = VAXC /NoDebug /Optimize"
$           Else

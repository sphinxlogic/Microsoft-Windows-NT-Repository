...
$!
$! If you have a pre DECC V5.0 compiler use __STDC__ otherwise don't
$!
$ DEFS = "/Define = (""USE_VARARGS=1"", ""USE_PROTOTYPES=0"", ""USE_CONST"")"
$ WRITE SYS$OUTPUT ""
$ WRITE SYS$OUTPUT "%%make-tiff.com - cc qualifier __STDC__ and BSDTYPES are not being used"
$ WRITE SYS$OUTPUT " - if compile fails, uncomment correct line make_tiff.com"
$ WRITE SYS$OUTPUT " - and re-execute the procedure"
$ WRITE SYS$OUTPUT ""
$!
$! DECC V5.0 and beyond complain about __STDC__ 
$!

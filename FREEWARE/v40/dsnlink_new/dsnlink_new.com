...
COPYRIGHT:
     ...
     Copyright © 1997-1998 by MadGoat Software.
     ALL RIGHTS RESERVED.
...
PARAMETERS:
 ...
 {** Note -- parameters P2 through P6 are used by DSNlink_NEW.COM internally
     ...
     P7 - number of articles to be retreived in GET Processing (only if P2 = 
          $GET$).  Defaults to 1.
...
Internet:  dwing@fuggles.com or dwing@cisco.com
 ...
 =----------------------------------------------------------------------=
  ...
  5.4-5   11-OCT-1996  Dan Wing, dwing@cisco.com
     ...
     DSNlink_NEW_Get address and retreive articles.  Eliminated multiple
...
$  ENDIF
$
$  WRITE SYS$OUTPUT F$FAO("!/DSNlink_NEW, version !AS.!/Copyright © 1991-1996 Dan Wing.  Copyright © 1997-1998 MadGoat Software.!/Started by !AS on node !AS on !AS, !AS !8AS.", -
...
$! V1.2A has a different bug which prvents READ/EDIT from working with
...
$    SUBMIT -
     ...
     /PARAMETERS=( -
          ...
          "''P5'", -                     ! P5
          "''P6'", -                     ! P6
          'DSNLINK_GET_ARTICLE_COUNT') - ! P7 (# of articles to retreive)

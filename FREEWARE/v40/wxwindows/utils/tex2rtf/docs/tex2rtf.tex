...
\winhelpignore{\title{Manual for Tex2RTF 1.61:\\A \LaTeX\ to RTF and HTML converter}%
\author{Julian Smart}%
\date{June 1997}%
}%
\winhelponly{\title{Manual for Tex2RTF 1.61}%
...
above FTP site in the {\tt /pub/packages/wxwin} directory.
...
Specifies a caption (within a \commandrefn{figure}{figure} environment). This may

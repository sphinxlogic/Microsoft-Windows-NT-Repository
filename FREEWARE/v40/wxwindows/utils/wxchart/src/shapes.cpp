...
#ifdef __GNUG__
#pragma implementation "enhtext.h"
#endif
...
void Shape::SetSizeable(Bool size) { sizeable = size; }
...
// defined added
void Shape::OnBeginSize(float w, float h)
{               
	wxDebugMsg("OnBeginSize\n");
   //OnEraseContents();
}
...
void RectangleShape::OnRightClick(float x, float y, int keys) 
{ /*     
...
/*
  ...
  wxAllTypes.AddType(SHAPE_HANDLE, SHAPE_RECTANGLE,  "Control point shape");
*/
}

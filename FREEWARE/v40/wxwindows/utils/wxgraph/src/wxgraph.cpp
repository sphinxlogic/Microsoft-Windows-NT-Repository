...
void wxGraphLayout::AddArc(long id, long fromId, long toId, char *name, Bool hide)
{
  wxGraphEdge *edge;
...
void wxGraphLayout::SetNodeX(long id, float x)
{
}

void wxGraphLayout::SetNodeY(long id, float y)
{
}

void wxGraphLayout::SetNodeName(long id, char *name)
{
}
...
void wxGraphLayout::ActivateNode(long id, Bool active)
{
}

Bool wxGraphLayout::NodeActive(long id)
{
  return TRUE;
}

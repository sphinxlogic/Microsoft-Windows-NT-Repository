 ...
 *           of Windows. See also docs/readme.txt.
 */
...
//      case META_STRETCHBLT:
      case META_POLYGON:
      {
        ...
        rec->param1 = getshort(handle);
        rec->points = new wxPoint[(int)rec->param1];
...
wxXMetaFileDC::wxXMetaFileDC(char *file)
{
}

wxXMetaFileDC::~wxXMetaFileDC(void)
{
}

void wxXMetaFileDC::GetTextExtent(char *string, float *x, float *y,
                                 float *descent, float *externalLeading)
{
}

wxMetaFile *wxXMetaFileDC::Close(void)
{
  return NULL;
}

void wxXMetaFileDC::SetMapMode(int mode)
{
}

void wxXMetaFileDC::DrawLine(float x1, float y1, float x2, float y2)
{
}

void wxXMetaFileDC::DrawArc(float x1,float y1,float x2,float y2,float xc,float yc)
{
}

void wxXMetaFileDC::DrawPoint(float x, float y)
{
}

void wxXMetaFileDC::DrawLines(int n, wxPoint points[], float xoffset, float yoffset)
{
}

void wxXMetaFileDC::DrawPolygon(int n, wxPoint points[], float xoffset, float yoffset)
{
}

void wxXMetaFileDC::DrawRectangle(float x, float y, float width, float height)
{
}

void wxXMetaFileDC::DrawRoundedRectangle(float x, float y, float width, float height, float radius)
{
}

void wxXMetaFileDC::DrawEllipse(float x, float y, float width, float height)
{
}

void wxXMetaFileDC::DrawIcon(wxIcon *icon, float x, float y)
{
}

void wxXMetaFileDC::Clear(void)
{
}

void wxXMetaFileDC::SetFont(wxFont *font)
{
}

void wxXMetaFileDC::SetPen(wxPen *pen)
{
}

void wxXMetaFileDC::SetBrush(wxBrush *brush)
{
}

void wxXMetaFileDC::SetLogicalFunction(int function)
{
}

void wxXMetaFileDC::SetBackground(wxBrush *brush)
{
}

void wxXMetaFileDC::SetClippingRegion(float x, float y, float width, float height)
{
}

void wxXMetaFileDC::DestroyClippingRegion(void)
{
}

void wxXMetaFileDC::DrawText(char *text, float x, float y)
{
}

float wxXMetaFileDC::GetCharHeight(void)
{
  return 0.0;
}

float wxXMetaFileDC::GetCharWidth(void)
{
  return 0.0;
}

Bool wxXMetaFileDC::StartDoc(char *message)
{
  return FALSE;
}

void wxXMetaFileDC::EndDoc(void)
{
}

void wxXMetaFileDC::StartPage(void)
{
}

void wxXMetaFileDC::EndPage(void)
{
}

void wxXMetaFileDC::SetUserScale(float x, float y)
{
}

float wxXMetaFileDC::DeviceToLogicalX(int x)
{
  return 0.0;
}

float wxXMetaFileDC::DeviceToLogicalY(int y)
{
  return 0.0;
}

float wxXMetaFileDC::DeviceToLogicalXRel(int x)
{
  return 0.0;
}

float wxXMetaFileDC::DeviceToLogicalYRel(int y)
{
  return 0.0;
}

int wxXMetaFileDC::LogicalToDeviceX(float x)
{
  return 0;
}

int wxXMetaFileDC::LogicalToDeviceY(float y)
{
  return 0;
}

int wxXMetaFileDC::LogicalToDeviceXRel(float x)
{
  return 0;
}

int wxXMetaFileDC::LogicalToDeviceYRel(float y)
{
  return 0;
}


Bool wxXMetaFileDC::Blit(float xdest, float ydest, float width, float height,

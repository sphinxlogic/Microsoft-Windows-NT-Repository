...
\parskip=10pt
\parindent=0pt
\title{User Manual for wxWindows Property Sheet Classes Version 1.1}
\winhelponly{\author{by Julian Smart, A.I. Applications Institute, University of Edinburgh\\$$\image{}{prop1}$$}}

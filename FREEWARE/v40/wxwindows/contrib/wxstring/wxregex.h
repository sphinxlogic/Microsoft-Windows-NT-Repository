...
extern const wxRegex wxRXwhite;          // = "[ \n\t\r\v\f]+"
extern const wxRegex wxRXint;            // = "-?[0-9]+"
extern const wxRegex wxRXdouble;         // = "-?\\(\\([0-9]+\\.[0-9]*\\)\\|
                                     //    \\([0-9]+\\)\\|\\(\\.[0-9]+\\)\\)
                                     //    \\([eE][---+]?[0-9]+\\)?"
extern const wxRegex wxRXalpha;          // = "[A-Za-z]+"
extern const wxRegex wxRXlowercase;      // = "[a-z]+"
extern const wxRegex wxRXuppercase;      // = "[A-Z]+"
extern const wxRegex wxRXalphanum;       // = "[0-9A-Za-z]+"
extern const wxRegex wxRXidentifier;     // = "[A-Za-z_][A-Za-z0-9_]*"

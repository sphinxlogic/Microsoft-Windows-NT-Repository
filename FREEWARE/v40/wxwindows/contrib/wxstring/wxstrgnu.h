...
// constructors & assignment
 ...
 inline             wxString(const wxSubString&  x);
...
// concatenation
  ...
  inline wxString&  operator += (const wxString&     y); 
  wxString&         operator += (const wxSubString&  y);
...
inline wxString::~wxString() { if (rep != &_nilStrRep) delete[] (char *) rep; }

...
{ VARIABLES;  i = x.Contains(wxRXwhite); assert(i==0); }
//     returns nonzero if x contains any whitespace (space, tab, or
//     newline). Recall that `wxRXwhite' is a global whitespace wxRegex.
...
{ VARIABLES;  z = "  ab c"; z = z.After(wxRXwhite); assert(z=="ab c"); }
...
#ifndef VMS
{ VARIABLES;  z = "this string has five words"; i = Split(z, words, 10, wxRXwhite); 

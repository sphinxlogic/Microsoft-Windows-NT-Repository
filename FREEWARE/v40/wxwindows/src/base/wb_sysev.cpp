...
Bool wxSendEvent1(wxEvent& event, Bool external, wxList& list, Bool *stop)
{
  Bool handled = FALSE;
...
void wxRegisterEventClass(WXTYPE eventClassId, WXTYPE WXUNUSED(superClassId),
...
void wxDeleteEventLists(void)
{
  ...
  wxPrimaryEventHandlerList.Clear();

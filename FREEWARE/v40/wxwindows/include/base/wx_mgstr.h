...
WXDLLEXPORT extern char **wx_msg_str;
WXDLLEXPORT extern void wxSetLanguage(wxlanguage_t language);
...
#define wxSTR_PRINTING               wx_msg_str[23]
#define wxSTR_PRINTING_WAIT          wx_msg_str[24]

...
class WXDLLEXPORT wxRealRange: public wxObject
{
  DECLARE_CLASS(wxRealRange)
 public:
  double lo;
  double hi;
  wxRealRange(double lo, double hi);
};

class WXDLLEXPORT wxFormItemConstraint: public wxObject
{
  DECLARE_CLASS(wxFormItemConstraint)
 public:
  int Type;
...
// information.
class wxForm;
class WXDLLEXPORT wxFormItem: public wxObject
{
  DECLARE_DYNAMIC_CLASS(wxFormItem)
...
//  wxEditFunction CustomEditor;
  ...
  union
  {
   ...
   wxFormItem(int type = wxFORM_LONG, int item_type = wxFORM_DEFAULT);
   ~wxFormItem(void);
   ...
   Bool CheckDoubleValue(double val);
...
class WXDLLEXPORT wxForm: public wxObject
{
  DECLARE_DYNAMIC_CLASS(wxForm)
 private:
  int buttonUse;
  int buttonPlace;
 public:
...
WXDLLEXPORT wxFormItem *wxMakeFormButton(char *label, wxFunction fun);

WXDLLEXPORT wxFormItem *wxMakeFormMessage(char *label);

WXDLLEXPORT wxFormItem *wxMakeFormNewLine(void);

WXDLLEXPORT wxFormItem *wxMakeFormLong(char *label, long *var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);

WXDLLEXPORT wxFormItem *wxMakeFormShort(char *label, int *var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);

WXDLLEXPORT wxFormItem *wxMakeFormFloat(char *label, float *var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);

WXDLLEXPORT wxFormItem *wxMakeFormDouble(char *label, double *var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);

WXDLLEXPORT wxFormItem *wxMakeFormBool(char *label, Bool *var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);

WXDLLEXPORT wxFormItem *wxMakeFormString(char *label, char **var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);
...
/* NOT IMPLEMENTED
// List of strings
WXDLLEXPORT wxFormItem *wxMakeFormStringList(char *label, wxList **var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);

// List of longs
WXDLLEXPORT wxFormItem *wxMakeFormLongList(char *label, wxList **var,
  int item_type = wxFORM_DEFAULT, wxList *constraints = NULL,
  char *help_string = NULL, int style = 0,
  int width = -1, int height = -1);
*/
...
WXDLLEXPORT wxFormItemConstraint *wxMakeConstraintStrings(wxList *list);
WXDLLEXPORT wxFormItemConstraint *wxMakeConstraintStrings(char *first ...);
// wxFormItemConstraint *wxMakeConstraintLongs(wxList *list);
WXDLLEXPORT wxFormItemConstraint *wxMakeConstraintFunction(wxConstraintFunction func);
WXDLLEXPORT wxFormItemConstraint *wxMakeConstraintRange(double lo, double hi);

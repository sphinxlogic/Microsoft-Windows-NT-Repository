...
// Not yet used
class WXDLLEXPORT wxPrintInfo: public wxObject
{
...
WXDLLEXPORT Bool wxTransferFileToStream(char *filename, ostream& stream);
WXDLLEXPORT Bool wxTransferStreamToFile(istream& stream, char *filename);

 ...
 * Copyright:	(c) 1993, AIAI, University of Edinburgh
	Last change:  JS   28 May 97   11:41 am
 */
...
class WXDLLEXPORT wxDC: public wxbDC
{
...
WXDLLEXPORT HDC wxGetPrinterDC(void);

// Logical to device
// Absolute
#define XLOG2DEV(x) (floor(double(x)))

#define YLOG2DEV(y) (floor(double(y)))
...
// Logical to device
// Absolute
#define MS_XLOG2DEV(x) (floor((x) - logical_origin_x)*logical_scale_x*user_scale_x*system_scale_x + device_origin_x)

#define MS_YLOG2DEV(y) (floor((y) - logical_origin_y)*logical_scale_y*user_scale_y*system_scale_y + device_origin_y)

// Relative
#define MS_XLOG2DEVREL(x) (floor(x)*logical_scale_x*user_scale_x*system_scale_x)
#define MS_YLOG2DEVREL(y) (floor(y)*logical_scale_y*user_scale_y*system_scale_y)

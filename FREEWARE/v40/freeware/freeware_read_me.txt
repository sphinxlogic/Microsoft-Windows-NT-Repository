...
as well as notes specific to the V4.0 distribution.
...
Systems in such categories as:
         ...
         SYSTEM_MANAGEMENT    Tools related to system managemet, security, etc
...
includes Bliss-32 for OpenVMS VAX, Bliss-32 for OpenVMS Alpha, and Bliss-64 for
OpenVMS Alpha.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                     ...
                     General Freeware V4.0 release notes
                     -----------------------------------
  ...
  o Please take the time to examine the following files:
      ...
      [000000]AAAREADME.V4
      [000000]OPENVMS_FREQUENTLY_ASKED_QUESTIONS_FAQ.TXT;2

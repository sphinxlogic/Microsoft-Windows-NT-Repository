...
$
$ copy sys$scratch:fw%rm.txt DISK$FREEWAREV4_1:[000000]AAAREADME.V4
$ copy sys$scratch:fw%rm.txt DISK$FREEWAREV4_2:[000000]AAAREADME.V4
$ delete sys$scratch:fw%rm.txt;*
$
...
$ ff[0,7] = 12
$ catlist = "|GAMES|GRAPHICS|LANGUAGES|MISCELLANEOUS|MOTIFTOYS|NETWORKING|" +-
            "SOFTWARE|SYSTEMMANAGEMENT|STORAGEMANAGEMENT|BUILDTOOLS|" +-
            "UTILITIES|AFFINITY|WEBTOOLS|"
$
$loop1:
$ close/nolog infile

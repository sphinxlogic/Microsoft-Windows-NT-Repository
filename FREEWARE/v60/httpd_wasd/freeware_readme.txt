HTTPD_WASD, UTILITIES, VMS HTTP Server and CGI applications
...
Provides a multi-threaded HTTP server, for VMS 6.n, 7.n Alpha and VAX
platforms, and the TCP/IP BG: driver (i.e. supported for UCX v3/4.n, OpenVMS
...
environments such as Perl, PHP, FastCGI and Java.

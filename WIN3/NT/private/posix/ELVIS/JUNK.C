...
void MSG(char *fmt, ... )
{
	...
	for (count=1, param = va_arg( marker, char *);
			param != -1;
			param = va_arg( marker, long), count++) {
	    switch (count) {
	      case 1: arg1 = param; break;
	      case 2: arg2 = param; break;
	      case 3: arg3 = param; break;
	      case 4: arg4 = param; break;
	      case 5: arg5 = param; break;
	      case 6: arg6 = param; break;
	      case 7: arg7 = param; break;
	    }
	}
